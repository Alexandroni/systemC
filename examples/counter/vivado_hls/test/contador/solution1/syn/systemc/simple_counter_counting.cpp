...
const sc_lv<3> simple_counter_counting::ap_ST_fsm_state1 = "1";
const sc_lv<3> simple_counter_counting::ap_ST_fsm_state2 = "10";
const sc_lv<3> simple_counter_counting::ap_ST_fsm_state3 = "100";
const sc_lv<10> simple_counter_counting::ap_const_lv10_0 = "0000000000";
...
const sc_lv<10> simple_counter_counting::ap_const_lv10_1 = "1";
...
simple_counter_counting::simple_counter_counting(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( v_V_fu_98_p2 );
    sensitive << ( ap_CS_fsm_state3 );
    sensitive << ( tmp_read_fu_84_p2 );
    ...
    SC_METHOD(thread_tmp_read_fu_84_p2);
    sensitive << ( start );
    sensitive << ( ap_CS_fsm_state3 );

    SC_METHOD(thread_v_V_fu_98_p2);
    sensitive << ( v_V_1_fu_64 );
    ...
    sc_trace(mVcdFile, v_V_1_fu_64, "v_V_1_fu_64");
    sc_trace(mVcdFile, ap_CS_fsm, "ap_CS_fsm");
    sc_trace(mVcdFile, ap_CS_fsm_state2, "ap_CS_fsm_state2");
    sc_trace(mVcdFile, v_V_fu_98_p2, "v_V_fu_98_p2");
    sc_trace(mVcdFile, ap_CS_fsm_state3, "ap_CS_fsm_state3");
    sc_trace(mVcdFile, tmp_read_fu_84_p2, "tmp_read_fu_84_p2");
...
void simple_counter_counting::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && 
         esl_seteq<1,1,1>(tmp_read_fu_84_p2.read(), ap_const_lv1_1))) {
        v_V_1_fu_64 = v_V_fu_98_p2.read();
...
void simple_counter_counting::thread_simple_counter_aux_V() {
    simple_counter_aux_V = v_V_fu_98_p2.read();
}
...
void simple_counter_counting::thread_tmp_read_fu_84_p2() {
    tmp_read_fu_84_p2 =  (sc_lv<1>) (start.read());
}

void simple_counter_counting::thread_v_V_fu_98_p2() {
    v_V_fu_98_p2 = (!v_V_1_fu_64.read().is_01() || !ap_const_lv10_1.is_01())? sc_lv<10>(): (sc_biguint<10>(v_V_1_fu_64.read()) + sc_biguint<10>(ap_const_lv10_1));
}
