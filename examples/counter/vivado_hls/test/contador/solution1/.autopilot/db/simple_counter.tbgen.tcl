...
set portList { 
	...
	{ count_out sc_out sc_lv 10 signal 3 clk } 
}
set NewPortList {[ 
	...
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "start", "Type" : "None", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_simple_counter_counting_fu_48", "Port" : "start"}]},
			{"Name" : "clk", "Type" : "None", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_simple_counter_counting_fu_48", "Port" : "clk"}]},
			{"Name" : "reset", "Type" : "None", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_simple_counter_counting_fu_48", "Port" : "reset"}]},
			{"Name" : "count_out", "Type" : "Vld", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_simple_counter_counting_fu_48", "Port" : "count_out"}]},
			{"Name" : "simple_counter_aux_V", "Type" : "Vld", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_simple_counter_counting_fu_48", "Port" : "simple_counter_aux_V"}]},
			{"Name" : "simple_counter_ssdm_thread_M_counting", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_simple_counter_counting_fu_48", "Parent" : "0",
...
set Spec2ImplPortList { 
	...
	count_out { ap_vld {  { count_out out_data 1 10 } } }
}
