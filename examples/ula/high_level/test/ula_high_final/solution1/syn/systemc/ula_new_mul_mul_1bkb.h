...
#ifndef __ula_new_mul_mul_1bkb__HH__
#define __ula_new_mul_mul_1bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ula_new_mul_mul_1bkb) {
    ...
    SC_CTOR(ula_new_mul_mul_1bkb):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
