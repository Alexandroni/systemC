; ModuleID = '/home/alexandroni/Dropbox/TCC-JOAO-PEDRO/Vivado/final/examples/ula/simple/test/ula_simples_final/solution1/.autopilot/db/a.g.1.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.ula_new.12 = type { %"class._ap_sc_::sc_core::sc_in.3", %"class._ap_sc_::sc_core::sc_in.3", %"class._ap_sc_::sc_core::sc_in.3", %"class._ap_sc_::sc_core::sc_in.0.9", %"class._ap_sc_::sc_core::sc_out.11", %"class._ap_sc_::sc_core::sc_out.11" }
...
%"class._ap_sc_::sc_core::sc_inout.10" = type { %"class._ap_sc_::sc_core::sc_in.3" }
%"class.std::ios_base::Init.0" = type {}

@"ula_new::__ssdm_thread_M_opUla" = external global i1 ; [#uses=1 type=i1*]
@ssdm_ins_ula_new_0_0 = global %struct.ula_new.12 zeroinitializer, align 1 ; [#uses=0 type=%struct.ula_new.12*]
...
; [#uses=0]
define weak void @"ula_new::ula_new"(%struct.ula_new.12* %this, %"class.std::ios_base::Init.0"*) unnamed_addr nounwind uwtable align 2 {
  call void @llvm.dbg.value(metadata !{%struct.ula_new.12* %this}, i64 0, metadata !3467), !dbg !3469 ; [debug line = 13:3] [debug variable = this]
  call void (...)* @_ssdm_op_SpecTopModule(i8* getelementptr inbounds ([8 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !3470 ; [debug line = 15:5]
  call void (...)* @_ssdm_InlineSelf(i32 2) nounwind, !dbg !3472 ; [debug line = 15:71]
  %"ula_new::__ssdm_thread_M_opUla.load" = load i1* @"ula_new::__ssdm_thread_M_opUla", align 1, !dbg !3473 ; [#uses=1 type=i1] [debug line = 16:5]
  br i1 %"ula_new::__ssdm_thread_M_opUla.load", label %2, label %._crit_edge, !dbg !3473 ; [debug line = 16:5]

; <label>:2                                       ; preds = %1
  call void @"ula_new::opUla"(%struct.ula_new.12* %this), !dbg !3474 ; [debug line = 16:32]
  br label %._crit_edge, !dbg !3474               ; [debug line = 16:32]

._crit_edge:                                      ; preds = %2, %1
  call void (...)* @_ssdm_op_SpecProcessDecl(i8* getelementptr inbounds ([8 x i8]* @.str, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([6 x i8]* @.str9, i64 0, i64 0)) nounwind, !dbg !3475 ; [debug line = 16:41]
  %this.addr = getelementptr inbounds %struct.ula_new.12* %this, i64 0, i32 0, !dbg !3476 ; [#uses=3 type=%"class._ap_sc_::sc_core::sc_in.3"*] [debug line = 17:5]
  call void (...)* @_ssdm_op_SpecSensitive(i8* getelementptr inbounds ([6 x i8]* @.str9, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8]* @.str2, i64 0, i64 0), %"class._ap_sc_::sc_core::sc_in.3"* %this.addr, i32 0) nounwind, !dbg !3476 ; [debug line = 17:5]
  %this.addr.1 = getelementptr inbounds %struct.ula_new.12* %this, i64 0, i32 1, !dbg !3477 ; [#uses=3 type=%"class._ap_sc_::sc_core::sc_in.3"*] [debug line = 18:5]
  call void (...)* @_ssdm_op_SpecSensitive(i8* getelementptr inbounds ([6 x i8]* @.str9, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8]* @.str3, i64 0, i64 0), %"class._ap_sc_::sc_core::sc_in.3"* %this.addr.1, i32 0) nounwind, !dbg !3477 ; [debug line = 18:5]
  %this.addr.2 = getelementptr inbounds %struct.ula_new.12* %this, i64 0, i32 2, !dbg !3478 ; [#uses=3 type=%"class._ap_sc_::sc_core::sc_in.3"*] [debug line = 19:5]
  call void (...)* @_ssdm_op_SpecSensitive(i8* getelementptr inbounds ([6 x i8]* @.str9, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str4, i64 0, i64 0), %"class._ap_sc_::sc_core::sc_in.3"* %this.addr.2, i32 0) nounwind, !dbg !3478 ; [debug line = 19:5]
  %this.addr.3 = getelementptr inbounds %struct.ula_new.12* %this, i64 0, i32 3, !dbg !3479 ; [#uses=3 type=%"class._ap_sc_::sc_core::sc_in.0.9"*] [debug line = 20:5]
  call void (...)* @_ssdm_op_SpecSensitive(i8* getelementptr inbounds ([6 x i8]* @.str9, i64 0, i64 0), i8* getelementptr inbounds ([3 x i8]* @.str6, i64 0, i64 0), %"class._ap_sc_::sc_core::sc_in.0.9"* %this.addr.3, i32 0) nounwind, !dbg !3479 ; [debug line = 20:5]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([8 x i8]* @.str, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([7 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, %"class._ap_sc_::sc_core::sc_in.3"* %this.addr) nounwind, !dbg !3480 ; [debug line = 21:5]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([8 x i8]* @.str, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([7 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, %"class._ap_sc_::sc_core::sc_in.3"* %this.addr.1) nounwind, !dbg !3481 ; [debug line = 22:5]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([8 x i8]* @.str, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([7 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str4, i64 0, i64 0), i32 0, i32 0, %"class._ap_sc_::sc_core::sc_in.3"* %this.addr.2) nounwind, !dbg !3482 ; [debug line = 23:5]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([8 x i8]* @.str, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([13 x i8]* @.str5, i64 0, i64 0), i8* getelementptr inbounds ([3 x i8]* @.str6, i64 0, i64 0), i32 0, i32 0, %"class._ap_sc_::sc_core::sc_in.0.9"* %this.addr.3) nounwind, !dbg !3483 ; [debug line = 24:5]
  %this.addr.4 = getelementptr inbounds %struct.ula_new.12* %this, i64 0, i32 4, !dbg !3484 ; [#uses=2 type=%"class._ap_sc_::sc_core::sc_out.11"*] [debug line = 25:5]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([8 x i8]* @.str, i64 0, i64 0), i32 1, i8* getelementptr inbounds ([7 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8]* @.str7, i64 0, i64 0), i32 0, i32 0, %"class._ap_sc_::sc_core::sc_out.11"* %this.addr.4) nounwind, !dbg !3484 ; [debug line = 25:5]
  %this.addr.5 = getelementptr inbounds %struct.ula_new.12* %this, i64 0, i32 5, !dbg !3485 ; [#uses=2 type=%"class._ap_sc_::sc_core::sc_out.11"*] [debug line = 26:5]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([8 x i8]* @.str, i64 0, i64 0), i32 1, i8* getelementptr inbounds ([7 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8]* @.str8, i64 0, i64 0), i32 0, i32 0, %"class._ap_sc_::sc_core::sc_out.11"* %this.addr.5) nounwind, !dbg !3485 ; [debug line = 26:5]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str12, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8]* @.str2, i64 0, i64 0), %"class._ap_sc_::sc_core::sc_in.3"* %this.addr) nounwind, !dbg !3486 ; [debug line = 27:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str12, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8]* @.str3, i64 0, i64 0), %"class._ap_sc_::sc_core::sc_in.3"* %this.addr.1) nounwind, !dbg !3487 ; [debug line = 28:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str12, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str4, i64 0, i64 0), %"class._ap_sc_::sc_core::sc_in.3"* %this.addr.2) nounwind, !dbg !3488 ; [debug line = 29:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str12, i64 0, i64 0), i8* getelementptr inbounds ([3 x i8]* @.str6, i64 0, i64 0), %"class._ap_sc_::sc_core::sc_in.0.9"* %this.addr.3) nounwind, !dbg !3489 ; [debug line = 30:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str12, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8]* @.str7, i64 0, i64 0), %"class._ap_sc_::sc_core::sc_out.11"* %this.addr.4) nounwind, !dbg !3490 ; [debug line = 31:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str12, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8]* @.str8, i64 0, i64 0), %"class._ap_sc_::sc_core::sc_out.11"* %this.addr.5) nounwind, !dbg !3491 ; [debug line = 32:1]
  ret void, !dbg !3492                            ; [debug line = 19:1]
}

; [#uses=1]
define void @"ula_new::opUla"(%struct.ula_new.12* %this) nounwind uwtable noinline align 2 {
  call void @llvm.dbg.value(metadata !{%struct.ula_new.12* %this}, i64 0, metadata !3493), !dbg !3494 ; [debug line = 3:15] [debug variable = this]
  %this.addr = getelementptr inbounds %struct.ula_new.12* %this, i64 0, i32 0, !dbg !3495 ; [#uses=2 type=%"class._ap_sc_::sc_core::sc_in.3"*] [debug line = 4:4]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([8 x i8]* @.str, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([7 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, %"class._ap_sc_::sc_core::sc_in.3"* %this.addr) nounwind, !dbg !3495 ; [debug line = 4:4]
  %this.addr.6 = getelementptr inbounds %struct.ula_new.12* %this, i64 0, i32 1, !dbg !3497 ; [#uses=2 type=%"class._ap_sc_::sc_core::sc_in.3"*] [debug line = 5:3]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([8 x i8]* @.str, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([7 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, %"class._ap_sc_::sc_core::sc_in.3"* %this.addr.6) nounwind, !dbg !3497 ; [debug line = 5:3]
  %this.addr.7 = getelementptr inbounds %struct.ula_new.12* %this, i64 0, i32 2, !dbg !3498 ; [#uses=2 type=%"class._ap_sc_::sc_core::sc_in.3"*] [debug line = 6:3]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([8 x i8]* @.str, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([7 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str4, i64 0, i64 0), i32 0, i32 0, %"class._ap_sc_::sc_core::sc_in.3"* %this.addr.7) nounwind, !dbg !3498 ; [debug line = 6:3]
  %this.addr.8 = getelementptr inbounds %struct.ula_new.12* %this, i64 0, i32 3, !dbg !3499 ; [#uses=2 type=%"class._ap_sc_::sc_core::sc_in.0.9"*] [debug line = 7:3]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([8 x i8]* @.str, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([13 x i8]* @.str5, i64 0, i64 0), i8* getelementptr inbounds ([3 x i8]* @.str6, i64 0, i64 0), i32 0, i32 0, %"class._ap_sc_::sc_core::sc_in.0.9"* %this.addr.8) nounwind, !dbg !3499 ; [debug line = 7:3]
  %this.addr.9 = getelementptr inbounds %struct.ula_new.12* %this, i64 0, i32 4, !dbg !3500 ; [#uses=2 type=%"class._ap_sc_::sc_core::sc_out.11"*] [debug line = 8:3]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([8 x i8]* @.str, i64 0, i64 0), i32 1, i8* getelementptr inbounds ([7 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8]* @.str7, i64 0, i64 0), i32 0, i32 0, %"class._ap_sc_::sc_core::sc_out.11"* %this.addr.9) nounwind, !dbg !3500 ; [debug line = 8:3]
  %this.addr.10 = getelementptr inbounds %struct.ula_new.12* %this, i64 0, i32 5, !dbg !3501 ; [#uses=2 type=%"class._ap_sc_::sc_core::sc_out.11"*] [debug line = 9:3]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([8 x i8]* @.str, i64 0, i64 0), i32 1, i8* getelementptr inbounds ([7 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8]* @.str8, i64 0, i64 0), i32 0, i32 0, %"class._ap_sc_::sc_core::sc_out.11"* %this.addr.10) nounwind, !dbg !3501 ; [debug line = 9:3]
  call void (...)* @_ssdm_op_SpecProcessDef(i8* getelementptr inbounds ([8 x i8]* @.str, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([6 x i8]* @.str9, i64 0, i64 0)) nounwind, !dbg !3502 ; [debug line = 10:3]
  call void (...)* @_ssdm_InlineSelf(i32 2) nounwind, !dbg !3503 ; [debug line = 10:82]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([10 x i8]* @.str10, i64 0, i64 0)) nounwind, !dbg !3504 ; [#uses=1 type=i32] [debug line = 10:150]
  call void (...)* @_ssdm_UnrollRegion(i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str11, i64 0, i64 0)) nounwind, !dbg !3505 ; [debug line = 10:190]
  call void (...)* @_ssdm_op_SpecProtocol(i32 1) nounwind, !dbg !3506 ; [debug line = 10:223]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str12, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8]* @.str2, i64 0, i64 0), %"class._ap_sc_::sc_core::sc_in.3"* %this.addr) nounwind, !dbg !3507 ; [debug line = 11:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str12, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8]* @.str3, i64 0, i64 0), %"class._ap_sc_::sc_core::sc_in.3"* %this.addr.6) nounwind, !dbg !3508 ; [debug line = 12:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str12, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str4, i64 0, i64 0), %"class._ap_sc_::sc_core::sc_in.3"* %this.addr.7) nounwind, !dbg !3509 ; [debug line = 13:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str12, i64 0, i64 0), i8* getelementptr inbounds ([3 x i8]* @.str6, i64 0, i64 0), %"class._ap_sc_::sc_core::sc_in.0.9"* %this.addr.8) nounwind, !dbg !3510 ; [debug line = 14:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str12, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8]* @.str7, i64 0, i64 0), %"class._ap_sc_::sc_core::sc_out.11"* %this.addr.9) nounwind, !dbg !3511 ; [debug line = 15:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str12, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8]* @.str8, i64 0, i64 0), %"class._ap_sc_::sc_core::sc_out.11"* %this.addr.10) nounwind, !dbg !3512 ; [debug line = 16:1]
  %this.addr.11 = getelementptr inbounds %struct.ula_new.12* %this, i64 0, i32 3, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, !dbg !3513 ; [#uses=1 type=i2*] [debug line = 374:13@112:21@180:66@338:73@7:9]
  %val.V = load volatile i2* %this.addr.11, align 1, !dbg !3513 ; [#uses=1 type=i2] [debug line = 374:13@112:21@180:66@338:73@7:9]
  call void @llvm.dbg.value(metadata !{i2 %val.V}, i64 0, metadata !3522), !dbg !3513 ; [debug line = 374:13@112:21@180:66@338:73@7:9] [debug variable = val.V]
  %tmp = zext i2 %val.V to i32, !dbg !3521        ; [#uses=1 type=i32] [debug line = 7:9]
  switch i32 %tmp, label %._crit_edge [
    i32 1, label %1
    i32 2, label %3
    i32 3, label %5
  ], !dbg !3521                                   ; [debug line = 7:9]

; <label>:1                                       ; preds = %0
  %P.assign = getelementptr inbounds %struct.ula_new.12* %this, i64 0, i32 0, i32 0, i32 0, i32 0, !dbg !3530 ; [#uses=2 type=i1*] [debug line = 180:66@369:68@10:10]
  call void @llvm.dbg.value(metadata !{i1* %P.assign}, i64 0, metadata !3536), !dbg !3537 ; [debug line = 166:90@180:66@369:68@10:10] [debug variable = P]
  %tmp.1 = load volatile i1* %P.assign, align 1, !dbg !3538 ; [#uses=1 type=i1] [debug line = 166:95@180:66@369:68@10:10]
  call void @llvm.dbg.value(metadata !{i1 %tmp.1}, i64 0, metadata !3540), !dbg !3530 ; [debug line = 180:66@369:68@10:10] [debug variable = tmp]
  %P.assign.1 = getelementptr inbounds %struct.ula_new.12* %this, i64 0, i32 1, i32 0, i32 0, i32 0, !dbg !3541 ; [#uses=2 type=i1*] [debug line = 180:66@369:68@10:21]
  call void @llvm.dbg.value(metadata !{i1* %P.assign.1}, i64 0, metadata !3536), !dbg !3544 ; [debug line = 166:90@180:66@369:68@10:21] [debug variable = P]
  %tmp.2 = load volatile i1* %P.assign.1, align 1, !dbg !3545 ; [#uses=1 type=i1] [debug line = 166:95@180:66@369:68@10:21]
  call void @llvm.dbg.value(metadata !{i1 %tmp.2}, i64 0, metadata !3540), !dbg !3541 ; [debug line = 180:66@369:68@10:21] [debug variable = tmp]
  %aux = xor i1 %tmp.1, %tmp.2, !dbg !3543        ; [#uses=2 type=i1] [debug line = 10:21]
  call void @llvm.dbg.value(metadata !{i1 %aux}, i64 0, metadata !3546), !dbg !3543 ; [debug line = 10:21] [debug variable = aux]
  call void @llvm.dbg.value(metadata !{i1* %P.assign}, i64 0, metadata !3536), !dbg !3547 ; [debug line = 166:90@180:66@369:68@11:11] [debug variable = P]
  %tmp.4 = load volatile i1* %P.assign, align 1, !dbg !3551 ; [#uses=1 type=i1] [debug line = 166:95@180:66@369:68@11:11]
  call void @llvm.dbg.value(metadata !{i1 %tmp.4}, i64 0, metadata !3540), !dbg !3548 ; [debug line = 180:66@369:68@11:11] [debug variable = tmp]
  br i1 %tmp.4, label %2, label %._crit_edge, !dbg !3550 ; [debug line = 11:11]

; <label>:2                                       ; preds = %1
  call void @llvm.dbg.value(metadata !{i1* %P.assign.1}, i64 0, metadata !3536), !dbg !3552 ; [debug line = 166:90@180:66@369:68@11:23] [debug variable = P]
  %tmp.7 = load volatile i1* %P.assign.1, align 1, !dbg !3556 ; [#uses=1 type=i1] [debug line = 166:95@180:66@369:68@11:23]
  call void @llvm.dbg.value(metadata !{i1 %tmp.7}, i64 0, metadata !3540), !dbg !3553 ; [debug line = 180:66@369:68@11:23] [debug variable = tmp]
  br label %._crit_edge

; <label>:3                                       ; preds = %0
  %P.assign.2 = getelementptr inbounds %struct.ula_new.12* %this, i64 0, i32 0, i32 0, i32 0, i32 0, !dbg !3557 ; [#uses=1 type=i1*] [debug line = 180:66@369:68@15:10]
  call void @llvm.dbg.value(metadata !{i1* %P.assign.2}, i64 0, metadata !3536), !dbg !3560 ; [debug line = 166:90@180:66@369:68@15:10] [debug variable = P]
  %tmp.5 = load volatile i1* %P.assign.2, align 1, !dbg !3561 ; [#uses=1 type=i1] [debug line = 166:95@180:66@369:68@15:10]
  call void @llvm.dbg.value(metadata !{i1 %tmp.5}, i64 0, metadata !3540), !dbg !3557 ; [debug line = 180:66@369:68@15:10] [debug variable = tmp]
  br i1 %tmp.5, label %4, label %._crit_edge, !dbg !3559 ; [debug line = 15:10]

; <label>:4                                       ; preds = %3
  %P.assign.4 = getelementptr inbounds %struct.ula_new.12* %this, i64 0, i32 1, i32 0, i32 0, i32 0, !dbg !3562 ; [#uses=1 type=i1*] [debug line = 180:66@369:68@15:22]
  call void @llvm.dbg.value(metadata !{i1* %P.assign.4}, i64 0, metadata !3536), !dbg !3565 ; [debug line = 166:90@180:66@369:68@15:22] [debug variable = P]
  %tmp.8 = load volatile i1* %P.assign.4, align 1, !dbg !3566 ; [#uses=1 type=i1] [debug line = 166:95@180:66@369:68@15:22]
  call void @llvm.dbg.value(metadata !{i1 %tmp.8}, i64 0, metadata !3540), !dbg !3562 ; [debug line = 180:66@369:68@15:22] [debug variable = tmp]
  br label %._crit_edge

; <label>:5                                       ; preds = %0
  %P.assign.3 = getelementptr inbounds %struct.ula_new.12* %this, i64 0, i32 0, i32 0, i32 0, i32 0, !dbg !3567 ; [#uses=1 type=i1*] [debug line = 180:66@369:68@19:10]
  call void @llvm.dbg.value(metadata !{i1* %P.assign.3}, i64 0, metadata !3536), !dbg !3570 ; [debug line = 166:90@180:66@369:68@19:10] [debug variable = P]
  %tmp.6 = load volatile i1* %P.assign.3, align 1, !dbg !3571 ; [#uses=1 type=i1] [debug line = 166:95@180:66@369:68@19:10]
  call void @llvm.dbg.value(metadata !{i1 %tmp.6}, i64 0, metadata !3540), !dbg !3567 ; [debug line = 180:66@369:68@19:10] [debug variable = tmp]
  br i1 %tmp.6, label %._crit_edge, label %6, !dbg !3569 ; [debug line = 19:10]

; <label>:6                                       ; preds = %5
  %P.assign.5 = getelementptr inbounds %struct.ula_new.12* %this, i64 0, i32 1, i32 0, i32 0, i32 0, !dbg !3572 ; [#uses=1 type=i1*] [debug line = 180:66@369:68@19:22]
  call void @llvm.dbg.value(metadata !{i1* %P.assign.5}, i64 0, metadata !3536), !dbg !3575 ; [debug line = 166:90@180:66@369:68@19:22] [debug variable = P]
  %tmp.9 = load volatile i1* %P.assign.5, align 1, !dbg !3576 ; [#uses=1 type=i1] [debug line = 166:95@180:66@369:68@19:22]
  call void @llvm.dbg.value(metadata !{i1 %tmp.9}, i64 0, metadata !3540), !dbg !3572 ; [debug line = 180:66@369:68@19:22] [debug variable = tmp]
  br label %._crit_edge, !dbg !3574               ; [debug line = 19:22]

._crit_edge:                                      ; preds = %6, %5, %4, %3, %2, %1, %0
  %v = phi i1 [ %aux, %2 ], [ %tmp.8, %4 ], [ %tmp.9, %6 ], [ false, %0 ], [ %aux, %1 ], [ false, %3 ], [ true, %5 ] ; [#uses=1 type=i1]
  %v.1 = phi i1 [ %tmp.7, %2 ], [ false, %4 ], [ false, %6 ], [ false, %0 ], [ false, %1 ], [ false, %3 ], [ false, %5 ] ; [#uses=1 type=i1]
  call void @llvm.dbg.value(metadata !{i1 %v}, i64 0, metadata !3577), !dbg !3579 ; [debug line = 206:21@414:73@28:1] [debug variable = v]
  %P.assign.6 = getelementptr inbounds %struct.ula_new.12* %this, i64 0, i32 4, i32 0, i32 0, i32 0, i32 0, i32 0, !dbg !3583 ; [#uses=1 type=i1*] [debug line = 207:13@414:73@28:1]
  call void @llvm.dbg.value(metadata !{i1* %P.assign.6}, i64 0, metadata !3584), !dbg !3585 ; [debug line = 128:96@207:13@414:73@28:1] [debug variable = P]
  store volatile i1 %v, i1* %P.assign.6, align 1, !dbg !3586 ; [debug line = 167:116@207:13@414:73@28:1]
  call void @llvm.dbg.value(metadata !{i1 %v.1}, i64 0, metadata !3577), !dbg !3588 ; [debug line = 206:21@414:73@29:1] [debug variable = v]
  %P.assign.7 = getelementptr inbounds %struct.ula_new.12* %this, i64 0, i32 5, i32 0, i32 0, i32 0, i32 0, i32 0, !dbg !3591 ; [#uses=1 type=i1*] [debug line = 207:13@414:73@29:1]
  call void @llvm.dbg.value(metadata !{i1* %P.assign.7}, i64 0, metadata !3584), !dbg !3592 ; [debug line = 128:96@207:13@414:73@29:1] [debug variable = P]
  store volatile i1 %v.1, i1* %P.assign.7, align 1, !dbg !3593 ; [debug line = 167:116@207:13@414:73@29:1]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([10 x i8]* @.str10, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !3594 ; [#uses=0 type=i32] [debug line = 29:22]
  ret void, !dbg !3595                            ; [debug line = 29:61]
}
...
!llvm.dbg.cu = !{!0}
!opencl.kernels = !{!3429, !3436, !3442, !3444, !3450, !3450, !3450, !3451, !3454, !3450, !3450, !3450, !3450, !3457, !3457, !3462, !3464, !3450, !3450, !3450, !3450, !3450, !3450, !3450, !3450, !3450, !3450, !3450, !3450, !3450, !3450, !3450, !3450, !3450, !3450, !3450, !3450, !3465}
!hls.encrypted.func = !{}
...
!938 = metadata !{i32 786478, i32 0, null, metadata !"opUla", metadata !"opUla", metadata !"_ZN7ula_new5opUlaEv", metadata !939, i32 3, metadata !940, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (%struct.ula_new.12*)* @"ula_new::opUla", null, metadata !1625, metadata !89, i32 4} ; [ DW_TAG_subprogram ]
...
!1640 = metadata !{i32 786478, i32 0, metadata !948, metadata !"write", metadata !"write", metadata !"_ZN7_ap_sc_7sc_core8sc_inoutIbE5writeERKb", metadata !950, i32 414, metadata !1598, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1597, metadata !89, i32 414} ; [ DW_TAG_subprogram ]
!1641 = metadata !{i32 786478, i32 0, metadata !948, metadata !"write<bool>", metadata !"write<bool>", metadata !"_ZN7_ap_sc_7sc_core18sc_signal_inout_ifIbE5writeIbEEvRKT_", metadata !950, i32 205, metadata !1642, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, metadata !1644, null, metadata !89, i32 205} ; [ DW_TAG_subprogram ]
...
!1646 = metadata !{i32 786478, i32 0, metadata !950, metadata !"_ssdm_op_WRITE<bool>", metadata !"_ssdm_op_WRITE<bool>", metadata !"_Z14_ssdm_op_WRITEIbEvRVbRKT_", metadata !950, i32 128, metadata !1647, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, metadata !1650, null, metadata !89, i32 167} ; [ DW_TAG_subprogram ]
...
!1652 = metadata !{i32 786478, i32 0, null, metadata !"operator unsigned char", metadata !"operator unsigned char", metadata !"_ZNK11ap_int_baseILi2ELb0ELb1EEcvhEv", metadata !891, i32 1710, metadata !1218, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1217, metadata !89, i32 1710} ; [ DW_TAG_subprogram ]
!1653 = metadata !{i32 786478, i32 0, metadata !948, metadata !"read", metadata !"read", metadata !"_ZN7_ap_sc_7sc_core5sc_inINS_5sc_dt7sc_uintILi2EEEE4readEv", metadata !950, i32 338, metadata !1524, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1523, metadata !89, i32 338} ; [ DW_TAG_subprogram ]
!1654 = metadata !{i32 786478, i32 0, metadata !948, metadata !"read", metadata !"read", metadata !"_ZN7_ap_sc_7sc_core15sc_signal_in_ifINS_5sc_dt7sc_uintILi2EEEE4readEv", metadata !950, i32 180, metadata !1474, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1473, metadata !89, i32 180} ; [ DW_TAG_subprogram ]
!1655 = metadata !{i32 786478, i32 0, metadata !950, metadata !"_ssdm_op_READ<2>", metadata !"_ssdm_op_READ<2>", metadata !"_Z13_ssdm_op_READILi2EEN7_ap_sc_5sc_dt7sc_uintIXT_EEERVS3_", metadata !950, i32 105, metadata !1656, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, metadata !1659, null, metadata !89, i32 111} ; [ DW_TAG_subprogram ]
...
!1661 = metadata !{i32 786478, i32 0, metadata !1071, metadata !"operator=", metadata !"operator=", metadata !"_ZN7_ap_sc_5sc_dt7sc_uintILi2EEaSERVKS2_", metadata !1073, i32 373, metadata !1460, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1459, metadata !89, i32 373} ; [ DW_TAG_subprogram ]
!1662 = metadata !{i32 786478, i32 0, metadata !1071, metadata !"sc_uint", metadata !"sc_uint", metadata !"_ZN7_ap_sc_5sc_dt7sc_uintILi2EEC1Ev", metadata !1073, i32 272, metadata !1381, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1380, metadata !89, i32 272} ; [ DW_TAG_subprogram ]
!1663 = metadata !{i32 786478, i32 0, metadata !1071, metadata !"sc_uint", metadata !"sc_uint", metadata !"_ZN7_ap_sc_5sc_dt7sc_uintILi2EEC2Ev", metadata !1073, i32 272, metadata !1381, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1380, metadata !89, i32 272} ; [ DW_TAG_subprogram ]
!1664 = metadata !{i32 786478, i32 0, null, metadata !"ap_int_base", metadata !"ap_int_base", metadata !"_ZN11ap_int_baseILi2ELb0ELb1EEC2Ev", metadata !891, i32 1494, metadata !1092, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1091, metadata !89, i32 1494} ; [ DW_TAG_subprogram ]
!1665 = metadata !{i32 786478, i32 0, null, metadata !"ssdm_int", metadata !"ssdm_int", metadata !"_ZN8ssdm_intILi2ELb0EEC2Ev", metadata !1080, i32 6, metadata !1085, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1084, metadata !89, i32 6} ; [ DW_TAG_subprogram ]
!1666 = metadata !{i32 786478, i32 0, metadata !948, metadata !"sc_module_name", metadata !"sc_module_name", metadata !"_ZN7_ap_sc_7sc_core14sc_module_nameC1EPKc", metadata !950, i32 581, metadata !1632, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1631, metadata !89, i32 581} ; [ DW_TAG_subprogram ]
!1667 = metadata !{i32 786478, i32 0, metadata !948, metadata !"sc_module_name", metadata !"sc_module_name", metadata !"_ZN7_ap_sc_7sc_core14sc_module_nameC2EPKc", metadata !950, i32 581, metadata !1632, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1631, metadata !89, i32 581} ; [ DW_TAG_subprogram ]
!1668 = metadata !{i32 786478, i32 0, null, metadata !"ula_new", metadata !"ula_new", metadata !"_ZN7ula_newC1EN7_ap_sc_7sc_core14sc_module_nameE", metadata !944, i32 13, metadata !1627, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1626, metadata !89, i32 14} ; [ DW_TAG_subprogram ]
!1669 = metadata !{i32 786478, i32 0, null, metadata !"ula_new", metadata !"ula_new", metadata !"_ZN7ula_newC2EN7_ap_sc_7sc_core14sc_module_nameE", metadata !944, i32 13, metadata !1627, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (%struct.ula_new.12*, %"class.std::ios_base::Init.0"*)* @"ula_new::ula_new", null, metadata !1626, metadata !89, i32 14} ; [ DW_TAG_subprogram ]
!1670 = metadata !{i32 786478, i32 0, metadata !948, metadata !"sc_out", metadata !"sc_out", metadata !"_ZN7_ap_sc_7sc_core6sc_outIbEC1Ev", metadata !950, i32 430, metadata !1618, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1617, metadata !89, i32 430} ; [ DW_TAG_subprogram ]
!1671 = metadata !{i32 786478, i32 0, metadata !948, metadata !"sc_out", metadata !"sc_out", metadata !"_ZN7_ap_sc_7sc_core6sc_outIbEC2Ev", metadata !950, i32 430, metadata !1618, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1617, metadata !89, i32 430} ; [ DW_TAG_subprogram ]
!1672 = metadata !{i32 786478, i32 0, metadata !948, metadata !"sc_inout", metadata !"sc_inout", metadata !"_ZN7_ap_sc_7sc_core8sc_inoutIbEC2Ev", metadata !950, i32 410, metadata !1591, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1590, metadata !89, i32 410} ; [ DW_TAG_subprogram ]
!1673 = metadata !{i32 786478, i32 0, metadata !948, metadata !"sc_port_b", metadata !"sc_port_b", metadata !"_ZN7_ap_sc_7sc_core9sc_port_bINS0_18sc_signal_inout_ifIbEEEC2Ev", metadata !950, i32 272, metadata !1565, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1564, metadata !89, i32 272} ; [ DW_TAG_subprogram ]
!1674 = metadata !{i32 786478, i32 0, metadata !948, metadata !"sc_signal_inout_if", metadata !"sc_signal_inout_if", metadata !"_ZN7_ap_sc_7sc_core18sc_signal_inout_ifIbEC1Ev", metadata !950, i32 197, metadata !1555, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1554, metadata !89, i32 197} ; [ DW_TAG_subprogram ]
...
!1676 = metadata !{i32 786478, i32 0, metadata !948, metadata !"sc_signal_in_if", metadata !"sc_signal_in_if", metadata !"_ZN7_ap_sc_7sc_core15sc_signal_in_ifIbEC2Ev", metadata !950, i32 176, metadata !975, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !974, metadata !89, i32 176} ; [ DW_TAG_subprogram ]
!1677 = metadata !{i32 786478, i32 0, metadata !948, metadata !"sc_interface", metadata !"sc_interface", metadata !"_ZN7_ap_sc_7sc_core12sc_interfaceC2Ev", metadata !950, i32 165, metadata !969, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !968, metadata !89, i32 165} ; [ DW_TAG_subprogram ]
!1678 = metadata !{i32 786478, i32 0, metadata !948, metadata !"sc_port_base", metadata !"sc_port_base", metadata !"_ZN7_ap_sc_7sc_core12sc_port_baseC2Ev", metadata !950, i32 265, metadata !959, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !958, metadata !89, i32 265} ; [ DW_TAG_subprogram ]
!1679 = metadata !{i32 786478, i32 0, metadata !948, metadata !"sc_in", metadata !"sc_in", metadata !"_ZN7_ap_sc_7sc_core5sc_inINS_5sc_dt7sc_uintILi2EEEEC1Ev", metadata !950, i32 334, metadata !1517, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1516, metadata !89, i32 334} ; [ DW_TAG_subprogram ]
!1680 = metadata !{i32 786478, i32 0, metadata !948, metadata !"sc_in", metadata !"sc_in", metadata !"_ZN7_ap_sc_7sc_core5sc_inINS_5sc_dt7sc_uintILi2EEEEC2Ev", metadata !950, i32 334, metadata !1517, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1516, metadata !89, i32 334} ; [ DW_TAG_subprogram ]
!1681 = metadata !{i32 786478, i32 0, metadata !948, metadata !"sc_port_b", metadata !"sc_port_b", metadata !"_ZN7_ap_sc_7sc_core9sc_port_bINS0_15sc_signal_in_ifINS_5sc_dt7sc_uintILi2EEEEEEC2Ev", metadata !950, i32 272, metadata !1490, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1489, metadata !89, i32 272} ; [ DW_TAG_subprogram ]
!1682 = metadata !{i32 786478, i32 0, metadata !948, metadata !"sc_signal_in_if", metadata !"sc_signal_in_if", metadata !"_ZN7_ap_sc_7sc_core15sc_signal_in_ifINS_5sc_dt7sc_uintILi2EEEEC1Ev", metadata !950, i32 176, metadata !1470, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1469, metadata !89, i32 176} ; [ DW_TAG_subprogram ]
...
!1684 = metadata !{i32 786478, i32 0, metadata !948, metadata !"sc_in", metadata !"sc_in", metadata !"_ZN7_ap_sc_7sc_core5sc_inIbEC1Ev", metadata !950, i32 365, metadata !1031, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1030, metadata !89, i32 365} ; [ DW_TAG_subprogram ]
!1685 = metadata !{i32 786478, i32 0, metadata !948, metadata !"sc_in", metadata !"sc_in", metadata !"_ZN7_ap_sc_7sc_core5sc_inIbEC2Ev", metadata !950, i32 365, metadata !1031, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1030, metadata !89, i32 365} ; [ DW_TAG_subprogram ]
!1686 = metadata !{i32 786478, i32 0, metadata !948, metadata !"sc_port_b", metadata !"sc_port_b", metadata !"_ZN7_ap_sc_7sc_core9sc_port_bINS0_15sc_signal_in_ifIbEEEC2Ev", metadata !950, i32 272, metadata !996, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !995, metadata !89, i32 272} ; [ DW_TAG_subprogram ]
!1687 = metadata !{i32 786478, i32 0, metadata !948, metadata !"sc_signal_in_if", metadata !"sc_signal_in_if", metadata !"_ZN7_ap_sc_7sc_core15sc_signal_in_ifIbEC1Ev", metadata !950, i32 176, metadata !975, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !974, metadata !89, i32 176} ; [ DW_TAG_subprogram ]
!1688 = metadata !{i32 786478, i32 0, metadata !948, metadata !"read", metadata !"read", metadata !"_ZN7_ap_sc_7sc_core5sc_inIbE4readEv", metadata !950, i32 369, metadata !1038, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1037, metadata !89, i32 369} ; [ DW_TAG_subprogram ]
!1689 = metadata !{i32 786478, i32 0, metadata !948, metadata !"read", metadata !"read", metadata !"_ZN7_ap_sc_7sc_core15sc_signal_in_ifIbE4readEv", metadata !950, i32 180, metadata !979, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !978, metadata !89, i32 180} ; [ DW_TAG_subprogram ]
!1690 = metadata !{i32 786478, i32 0, metadata !1691, metadata !"_ssdm_op_READ<bool>", metadata !"_ssdm_op_READ<bool>", metadata !"_Z13_ssdm_op_READIbET_RVS0_", metadata !1691, i32 166, metadata !1692, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, metadata !1694, null, metadata !89, i32 166} ; [ DW_TAG_subprogram ]
...
!1746 = metadata !{i32 786484, i32 0, metadata !1747, metadata !"__ioinit", metadata !"__ioinit", metadata !"_ZStL8__ioinit", metadata !1748, i32 74, metadata !1749, i32 1, i32 1, null} ; [ DW_TAG_variable ]
...
!1758 = metadata !{i32 786484, i32 0, null, metadata !"ssdm_ins_ula_new_0_0", metadata !"ssdm_ins_ula_new_0_0", metadata !"", metadata !939, i32 33, metadata !943, i32 0, i32 1, %struct.ula_new.12* @ssdm_ins_ula_new_0_0} ; [ DW_TAG_variable ]
!1759 = metadata !{i32 786484, i32 0, null, metadata !"__is_signed", metadata !"__is_signed", metadata !"_ZN9__gnu_cxx24__numeric_traits_integer11__is_signedE", metadata !1760, i32 73, metadata !989, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1761 = metadata !{i32 786484, i32 0, null, metadata !"__digits", metadata !"__digits", metadata !"_ZN9__gnu_cxx24__numeric_traits_integer8__digitsE", metadata !1760, i32 76, metadata !168, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1762 = metadata !{i32 786484, i32 0, null, metadata !"__max_digits10", metadata !"__max_digits10", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating14__max_digits10E", metadata !1760, i32 111, metadata !168, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1763 = metadata !{i32 786484, i32 0, null, metadata !"__is_signed", metadata !"__is_signed", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating11__is_signedE", metadata !1760, i32 114, metadata !989, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1764 = metadata !{i32 786484, i32 0, null, metadata !"__digits10", metadata !"__digits10", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating10__digits10E", metadata !1760, i32 117, metadata !168, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1765 = metadata !{i32 786484, i32 0, null, metadata !"__max_exponent10", metadata !"__max_exponent10", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating16__max_exponent10E", metadata !1760, i32 120, metadata !168, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1766 = metadata !{i32 786484, i32 0, null, metadata !"__daylight", metadata !"__daylight", metadata !"", metadata !1767, i32 283, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1768 = metadata !{i32 786484, i32 0, null, metadata !"daylight", metadata !"daylight", metadata !"", metadata !1767, i32 297, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1769 = metadata !{i32 786484, i32 0, null, metadata !"getdate_err", metadata !"getdate_err", metadata !"", metadata !1767, i32 403, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1770 = metadata !{i32 786484, i32 0, null, metadata !"optind", metadata !"optind", metadata !"", metadata !1771, i32 72, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1772 = metadata !{i32 786484, i32 0, null, metadata !"opterr", metadata !"opterr", metadata !"", metadata !1771, i32 77, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1773 = metadata !{i32 786484, i32 0, null, metadata !"optopt", metadata !"optopt", metadata !"", metadata !1771, i32 81, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1774 = metadata !{i32 786484, i32 0, metadata !1775, metadata !"nothrow", metadata !"nothrow", metadata !"_ZSt7nothrow", metadata !1776, i32 70, metadata !1777, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1779 = metadata !{i32 786484, i32 0, metadata !115, metadata !"_S_once", metadata !"_S_once", metadata !"_ZNSt6locale7_S_onceE", metadata !117, i32 307, metadata !1780, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1782 = metadata !{i32 786484, i32 0, metadata !128, metadata !"_S_once", metadata !"_S_once", metadata !"_ZNSt6locale5facet7_S_onceE", metadata !117, i32 353, metadata !1780, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1783 = metadata !{i32 786484, i32 0, metadata !251, metadata !"_S_refcount", metadata !"_S_refcount", metadata !"_ZNSt6locale2id11_S_refcountE", metadata !117, i32 456, metadata !84, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1784 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt7collate2idE", metadata !117, i32 634, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1785 = metadata !{i32 786484, i32 0, metadata !1749, metadata !"_S_refcount", metadata !"_S_refcount", metadata !"_ZNSt8ios_base4Init11_S_refcountE", metadata !5, i32 542, metadata !84, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1786 = metadata !{i32 786484, i32 0, metadata !1749, metadata !"_S_synced_with_stdio", metadata !"_S_synced_with_stdio", metadata !"_ZNSt8ios_base4Init20_S_synced_with_stdioE", metadata !5, i32 543, metadata !238, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1787 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt5ctype2idE", metadata !1788, i32 613, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1891 = metadata !{i32 786484, i32 0, metadata !1806, metadata !"id", metadata !"id", metadata !"_ZNSt5ctypeIcE2idE", metadata !1788, i32 696, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1892 = metadata !{i32 786484, i32 0, metadata !1893, metadata !"id", metadata !"id", metadata !"_ZNSt5ctypeIwE2idE", metadata !1788, i32 1198, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2025 = metadata !{i32 786484, i32 0, metadata !2026, metadata !"_S_atoms_out", metadata !"_S_atoms_out", metadata !"_ZNSt10__num_base12_S_atoms_outE", metadata !1788, i32 1543, metadata !172, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2032 = metadata !{i32 786484, i32 0, metadata !2026, metadata !"_S_atoms_in", metadata !"_S_atoms_in", metadata !"_ZNSt10__num_base11_S_atoms_inE", metadata !1788, i32 1547, metadata !172, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2033 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt8numpunct2idE", metadata !1788, i32 1657, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2034 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt7num_get2idE", metadata !1788, i32 1926, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2035 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt7num_put2idE", metadata !1788, i32 2264, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2036 = metadata !{i32 786484, i32 0, metadata !1747, metadata !"cin", metadata !"cin", metadata !"_ZSt3cin", metadata !1748, i32 60, metadata !2037, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2717 = metadata !{i32 786484, i32 0, metadata !1747, metadata !"cout", metadata !"cout", metadata !"_ZSt4cout", metadata !1748, i32 61, metadata !2718, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2719 = metadata !{i32 786484, i32 0, metadata !1747, metadata !"cerr", metadata !"cerr", metadata !"_ZSt4cerr", metadata !1748, i32 62, metadata !2718, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2720 = metadata !{i32 786484, i32 0, metadata !1747, metadata !"clog", metadata !"clog", metadata !"_ZSt4clog", metadata !1748, i32 63, metadata !2718, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2721 = metadata !{i32 786484, i32 0, metadata !1747, metadata !"wcin", metadata !"wcin", metadata !"_ZSt4wcin", metadata !1748, i32 66, metadata !2722, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!3394 = metadata !{i32 786484, i32 0, metadata !1747, metadata !"wcout", metadata !"wcout", metadata !"_ZSt5wcout", metadata !1748, i32 67, metadata !3395, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!3396 = metadata !{i32 786484, i32 0, metadata !1747, metadata !"wcerr", metadata !"wcerr", metadata !"_ZSt5wcerr", metadata !1748, i32 68, metadata !3395, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!3397 = metadata !{i32 786484, i32 0, metadata !1747, metadata !"wclog", metadata !"wclog", metadata !"_ZSt5wclog", metadata !1748, i32 69, metadata !3395, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!3398 = metadata !{i32 786484, i32 0, null, metadata !"_IO_2_1_stdin_", metadata !"_IO_2_1_stdin_", metadata !"", metadata !3399, i32 321, metadata !3400, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!3401 = metadata !{i32 786484, i32 0, null, metadata !"_IO_2_1_stdout_", metadata !"_IO_2_1_stdout_", metadata !"", metadata !3399, i32 322, metadata !3400, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!3402 = metadata !{i32 786484, i32 0, null, metadata !"_IO_2_1_stderr_", metadata !"_IO_2_1_stderr_", metadata !"", metadata !3399, i32 323, metadata !3400, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!3403 = metadata !{i32 786484, i32 0, null, metadata !"sys_nerr", metadata !"sys_nerr", metadata !"", metadata !3404, i32 26, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!3405 = metadata !{i32 786484, i32 0, null, metadata !"_sys_nerr", metadata !"_sys_nerr", metadata !"", metadata !3404, i32 30, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!3406 = metadata !{i32 786484, i32 0, null, metadata !"signgam", metadata !"signgam", metadata !"", metadata !3407, i32 149, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!3408 = metadata !{i32 786484, i32 0, metadata !948, metadata !"SC_BIND_PROXY_NIL", metadata !"SC_BIND_PROXY_NIL", metadata !"_ZN7_ap_sc_7sc_core17SC_BIND_PROXY_NILE", metadata !950, i32 505, metadata !3409, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!3428 = metadata !{i32 786484, i32 0, metadata !943, metadata !"__ssdm_thread_M_opUla", metadata !"__ssdm_thread_M_opUla", metadata !"_ZN7ula_new21__ssdm_thread_M_opUlaE", metadata !944, i32 7, metadata !238, i32 0, i32 1, i1* @"ula_new::__ssdm_thread_M_opUla"} ; [ DW_TAG_variable ]
!3429 = metadata !{void (%struct.ula_new.12*)* @"ula_new::opUla", metadata !3430, metadata !3431, metadata !3432, metadata !3433, metadata !3434, metadata !3435}
...
!3436 = metadata !{null, metadata !3437, metadata !3438, metadata !3439, metadata !3440, metadata !3441, metadata !3435}
...
!3442 = metadata !{null, metadata !3437, metadata !3438, metadata !3439, metadata !3440, metadata !3443, metadata !3435}
!3443 = metadata !{metadata !"kernel_arg_name", metadata !"v2"}
!3444 = metadata !{null, metadata !3445, metadata !3446, metadata !3447, metadata !3448, metadata !3449, metadata !3435}
...
!3450 = metadata !{null, metadata !3430, metadata !3431, metadata !3432, metadata !3433, metadata !3434, metadata !3435}
!3451 = metadata !{null, metadata !3437, metadata !3438, metadata !3452, metadata !3440, metadata !3453, metadata !3435}
!3452 = metadata !{metadata !"kernel_arg_type", metadata !"volatile sc_uint<2> &"}
!3453 = metadata !{metadata !"kernel_arg_name", metadata !"P"}
!3454 = metadata !{null, metadata !3437, metadata !3438, metadata !3455, metadata !3440, metadata !3456, metadata !3435}
!3455 = metadata !{metadata !"kernel_arg_type", metadata !"const volatile struct _ap_sc_::sc_dt::sc_uint<2> &"}
!3456 = metadata !{metadata !"kernel_arg_name", metadata !"op2"}
!3457 = metadata !{null, metadata !3458, metadata !3438, metadata !3459, metadata !3460, metadata !3461, metadata !3435}
!3458 = metadata !{metadata !"kernel_arg_addr_space", i32 1}
!3459 = metadata !{metadata !"kernel_arg_type", metadata !"char*"}
!3460 = metadata !{metadata !"kernel_arg_type_qual", metadata !"const"}
!3461 = metadata !{metadata !"kernel_arg_name", metadata !""}
!3462 = metadata !{null, metadata !3437, metadata !3438, metadata !3463, metadata !3440, metadata !3461, metadata !3435}
!3463 = metadata !{metadata !"kernel_arg_type", metadata !"::sc_core::sc_module_name"}
!3464 = metadata !{void (%struct.ula_new.12*, %"class.std::ios_base::Init.0"*)* @"ula_new::ula_new", metadata !3437, metadata !3438, metadata !3463, metadata !3440, metadata !3461, metadata !3435}
!3465 = metadata !{null, metadata !3437, metadata !3438, metadata !3466, metadata !3440, metadata !3453, metadata !3435}
!3466 = metadata !{metadata !"kernel_arg_type", metadata !"volatile _Bool &"}
!3467 = metadata !{i32 786689, metadata !1669, metadata !"this", metadata !944, i32 16777229, metadata !3468, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!3468 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !943} ; [ DW_TAG_pointer_type ]
!3469 = metadata !{i32 13, i32 3, metadata !1669, null}
!3470 = metadata !{i32 15, i32 5, metadata !3471, null}
!3471 = metadata !{i32 786443, metadata !1669, i32 14, i32 2, metadata !944, i32 14} ; [ DW_TAG_lexical_block ]
!3472 = metadata !{i32 15, i32 71, metadata !3471, null}
!3473 = metadata !{i32 16, i32 5, metadata !3471, null}
!3474 = metadata !{i32 16, i32 32, metadata !3471, null}
!3475 = metadata !{i32 16, i32 41, metadata !3471, null}
!3476 = metadata !{i32 17, i32 5, metadata !3471, null}
!3477 = metadata !{i32 18, i32 5, metadata !3471, null}
!3478 = metadata !{i32 19, i32 5, metadata !3471, null}
!3479 = metadata !{i32 20, i32 5, metadata !3471, null}
!3480 = metadata !{i32 21, i32 5, metadata !3471, null}
!3481 = metadata !{i32 22, i32 5, metadata !3471, null}
!3482 = metadata !{i32 23, i32 5, metadata !3471, null}
!3483 = metadata !{i32 24, i32 5, metadata !3471, null}
!3484 = metadata !{i32 25, i32 5, metadata !3471, null}
!3485 = metadata !{i32 26, i32 5, metadata !3471, null}
!3486 = metadata !{i32 27, i32 1, metadata !3471, null}
!3487 = metadata !{i32 28, i32 1, metadata !3471, null}
!3488 = metadata !{i32 29, i32 1, metadata !3471, null}
!3489 = metadata !{i32 30, i32 1, metadata !3471, null}
!3490 = metadata !{i32 31, i32 1, metadata !3471, null}
!3491 = metadata !{i32 32, i32 1, metadata !3471, null}
!3492 = metadata !{i32 19, i32 1, metadata !3471, null}
!3493 = metadata !{i32 786689, metadata !938, metadata !"this", metadata !939, i32 16777219, metadata !3468, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!3494 = metadata !{i32 3, i32 15, metadata !938, null}
!3495 = metadata !{i32 4, i32 4, metadata !3496, null}
!3496 = metadata !{i32 786443, metadata !938, i32 4, i32 1, metadata !939, i32 0} ; [ DW_TAG_lexical_block ]
!3497 = metadata !{i32 5, i32 3, metadata !3496, null}
!3498 = metadata !{i32 6, i32 3, metadata !3496, null}
!3499 = metadata !{i32 7, i32 3, metadata !3496, null}
!3500 = metadata !{i32 8, i32 3, metadata !3496, null}
!3501 = metadata !{i32 9, i32 3, metadata !3496, null}
!3502 = metadata !{i32 10, i32 3, metadata !3496, null}
!3503 = metadata !{i32 10, i32 82, metadata !3496, null}
!3504 = metadata !{i32 10, i32 150, metadata !3496, null}
!3505 = metadata !{i32 10, i32 190, metadata !3496, null}
!3506 = metadata !{i32 10, i32 223, metadata !3496, null}
!3507 = metadata !{i32 11, i32 1, metadata !3496, null}
!3508 = metadata !{i32 12, i32 1, metadata !3496, null}
!3509 = metadata !{i32 13, i32 1, metadata !3496, null}
!3510 = metadata !{i32 14, i32 1, metadata !3496, null}
!3511 = metadata !{i32 15, i32 1, metadata !3496, null}
!3512 = metadata !{i32 16, i32 1, metadata !3496, null}
!3513 = metadata !{i32 374, i32 13, metadata !3514, metadata !3515}
!3514 = metadata !{i32 786443, metadata !1661, i32 373, i32 97, metadata !1073, i32 9} ; [ DW_TAG_lexical_block ]
!3515 = metadata !{i32 112, i32 21, metadata !3516, metadata !3517}
!3516 = metadata !{i32 786443, metadata !1655, i32 111, i32 88, metadata !1691, i32 8} ; [ DW_TAG_lexical_block ]
!3517 = metadata !{i32 180, i32 66, metadata !3518, metadata !3519}
!3518 = metadata !{i32 786443, metadata !1654, i32 180, i32 56, metadata !950, i32 7} ; [ DW_TAG_lexical_block ]
!3519 = metadata !{i32 338, i32 73, metadata !3520, metadata !3521}
!3520 = metadata !{i32 786443, metadata !1653, i32 338, i32 64, metadata !950, i32 6} ; [ DW_TAG_lexical_block ]
!3521 = metadata !{i32 7, i32 9, metadata !3496, null}
!3522 = metadata !{i32 790529, metadata !3523, metadata !"val.V", null, i32 112, metadata !3524, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!3523 = metadata !{i32 786688, metadata !3516, metadata !"val", metadata !1691, i32 112, metadata !1462, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3524 = metadata !{i32 786438, metadata !1071, metadata !"sc_uint<2>", metadata !1073, i32 269, i64 2, i64 8, i32 0, i32 0, null, metadata !3525, i32 0, null, metadata !1467} ; [ DW_TAG_class_field_type ]
!3525 = metadata !{metadata !3526}
!3526 = metadata !{i32 786438, null, metadata !"ap_int_base<2, false, true>", metadata !891, i32 1453, i64 2, i64 8, i32 0, i32 0, null, metadata !3527, i32 0, null, metadata !1378} ; [ DW_TAG_class_field_type ]
!3527 = metadata !{metadata !3528}
!3528 = metadata !{i32 786438, null, metadata !"ssdm_int<2 + 1024 * 0, false>", metadata !1080, i32 6, i64 2, i64 8, i32 0, i32 0, null, metadata !3529, i32 0, null, metadata !1088} ; [ DW_TAG_class_field_type ]
!3529 = metadata !{metadata !1082}
!3530 = metadata !{i32 180, i32 66, metadata !3531, metadata !3532}
!3531 = metadata !{i32 786443, metadata !1689, i32 180, i32 56, metadata !950, i32 28} ; [ DW_TAG_lexical_block ]
!3532 = metadata !{i32 369, i32 68, metadata !3533, metadata !3534}
!3533 = metadata !{i32 786443, metadata !1688, i32 369, i32 59, metadata !950, i32 27} ; [ DW_TAG_lexical_block ]
!3534 = metadata !{i32 10, i32 10, metadata !3535, null}
!3535 = metadata !{i32 786443, metadata !3496, i32 7, i32 19, metadata !939, i32 1} ; [ DW_TAG_lexical_block ]
!3536 = metadata !{i32 786689, metadata !1690, metadata !"P", metadata !1691, i32 16777382, metadata !1649, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3537 = metadata !{i32 166, i32 90, metadata !1690, metadata !3530}
!3538 = metadata !{i32 166, i32 95, metadata !3539, metadata !3530}
!3539 = metadata !{i32 786443, metadata !1690, i32 166, i32 93, metadata !1691, i32 29} ; [ DW_TAG_lexical_block ]
!3540 = metadata !{i32 786688, metadata !3531, metadata !"tmp", metadata !950, i32 180, metadata !238, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3541 = metadata !{i32 180, i32 66, metadata !3531, metadata !3542}
!3542 = metadata !{i32 369, i32 68, metadata !3533, metadata !3543}
!3543 = metadata !{i32 10, i32 21, metadata !3535, null}
!3544 = metadata !{i32 166, i32 90, metadata !1690, metadata !3541}
!3545 = metadata !{i32 166, i32 95, metadata !3539, metadata !3541}
!3546 = metadata !{i32 786688, metadata !3496, metadata !"aux", metadata !939, i32 5, metadata !238, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3547 = metadata !{i32 166, i32 90, metadata !1690, metadata !3548}
!3548 = metadata !{i32 180, i32 66, metadata !3531, metadata !3549}
!3549 = metadata !{i32 369, i32 68, metadata !3533, metadata !3550}
!3550 = metadata !{i32 11, i32 11, metadata !3535, null}
!3551 = metadata !{i32 166, i32 95, metadata !3539, metadata !3548}
!3552 = metadata !{i32 166, i32 90, metadata !1690, metadata !3553}
!3553 = metadata !{i32 180, i32 66, metadata !3531, metadata !3554}
!3554 = metadata !{i32 369, i32 68, metadata !3533, metadata !3555}
!3555 = metadata !{i32 11, i32 23, metadata !3535, null}
!3556 = metadata !{i32 166, i32 95, metadata !3539, metadata !3553}
!3557 = metadata !{i32 180, i32 66, metadata !3531, metadata !3558}
!3558 = metadata !{i32 369, i32 68, metadata !3533, metadata !3559}
!3559 = metadata !{i32 15, i32 10, metadata !3535, null}
!3560 = metadata !{i32 166, i32 90, metadata !1690, metadata !3557}
!3561 = metadata !{i32 166, i32 95, metadata !3539, metadata !3557}
!3562 = metadata !{i32 180, i32 66, metadata !3531, metadata !3563}
!3563 = metadata !{i32 369, i32 68, metadata !3533, metadata !3564}
!3564 = metadata !{i32 15, i32 22, metadata !3535, null}
!3565 = metadata !{i32 166, i32 90, metadata !1690, metadata !3562}
!3566 = metadata !{i32 166, i32 95, metadata !3539, metadata !3562}
!3567 = metadata !{i32 180, i32 66, metadata !3531, metadata !3568}
!3568 = metadata !{i32 369, i32 68, metadata !3533, metadata !3569}
!3569 = metadata !{i32 19, i32 10, metadata !3535, null}
!3570 = metadata !{i32 166, i32 90, metadata !1690, metadata !3567}
!3571 = metadata !{i32 166, i32 95, metadata !3539, metadata !3567}
!3572 = metadata !{i32 180, i32 66, metadata !3531, metadata !3573}
!3573 = metadata !{i32 369, i32 68, metadata !3533, metadata !3574}
!3574 = metadata !{i32 19, i32 22, metadata !3535, null}
!3575 = metadata !{i32 166, i32 90, metadata !1690, metadata !3572}
!3576 = metadata !{i32 166, i32 95, metadata !3539, metadata !3572}
...
!3579 = metadata !{i32 206, i32 21, metadata !3578, metadata !3580}
!3580 = metadata !{i32 414, i32 73, metadata !3581, metadata !3582}
!3581 = metadata !{i32 786443, metadata !1640, i32 414, i32 71, metadata !950, i32 2} ; [ DW_TAG_lexical_block ]
!3582 = metadata !{i32 28, i32 1, metadata !3496, null}
!3583 = metadata !{i32 207, i32 13, metadata !3578, metadata !3580}
!3584 = metadata !{i32 786689, metadata !1646, metadata !"P", metadata !950, i32 16777344, metadata !1649, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3585 = metadata !{i32 128, i32 96, metadata !1646, metadata !3583}
!3586 = metadata !{i32 167, i32 116, metadata !3587, metadata !3583}
!3587 = metadata !{i32 786443, metadata !1646, i32 167, i32 114, metadata !1691, i32 4} ; [ DW_TAG_lexical_block ]
!3588 = metadata !{i32 206, i32 21, metadata !3578, metadata !3589}
!3589 = metadata !{i32 414, i32 73, metadata !3581, metadata !3590}
!3590 = metadata !{i32 29, i32 1, metadata !3496, null}
!3591 = metadata !{i32 207, i32 13, metadata !3578, metadata !3589}
!3592 = metadata !{i32 128, i32 96, metadata !1646, metadata !3591}
!3593 = metadata !{i32 167, i32 116, metadata !3587, metadata !3591}
!3594 = metadata !{i32 29, i32 22, metadata !3496, null}
!3595 = metadata !{i32 29, i32 61, metadata !3496, null}
