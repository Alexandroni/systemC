...
define weak void @"ula_new::ula_new"(i1* %A, i1* %B, i1* %carryIn, i2* %op, i1* %C, i1* %carryOut) {
  ...
  call void @llvm.dbg.value(metadata !{i1* %A}, i64 0, metadata !102), !dbg !834
  call void @llvm.dbg.value(metadata !{i1* %B}, i64 0, metadata !835), !dbg !834
  call void @llvm.dbg.value(metadata !{i1* %carryIn}, i64 0, metadata !836), !dbg !834
  call void @llvm.dbg.value(metadata !{i2* %op}, i64 0, metadata !837), !dbg !834
  call void @llvm.dbg.value(metadata !{i1* %C}, i64 0, metadata !853), !dbg !834
  call void @llvm.dbg.value(metadata !{i1* %carryOut}, i64 0, metadata !864), !dbg !834
  call void (...)* @_ssdm_op_SpecTopModule([8 x i8]* @p_str, [8 x i8]* @p_str) nounwind, !dbg !865
  %ula_new_ssdm_thre = load i1* @ula_new_ssdm_thread_M_opUla, align 1, !dbg !867
  br i1 %ula_new_ssdm_thre, label %1, label %._crit_edge, !dbg !867

; <label>:1                                       ; preds = %0
  call void @"ula_new::opUla"(i1* %A, i1* %B, i1* %carryIn, i2* %op, i1* %C, i1* %carryOut), !dbg !868
  br label %._crit_edge, !dbg !868

._crit_edge:                                      ; preds = %1, %0
  call void (...)* @_ssdm_op_SpecProcessDecl([8 x i8]* @p_str, i32 0, [6 x i8]* @p_str9) nounwind, !dbg !869
  call void (...)* @_ssdm_op_SpecSensitive([6 x i8]* @p_str9, [2 x i8]* @p_str2, i1* %A, i32 0) nounwind, !dbg !870
  call void (...)* @_ssdm_op_SpecSensitive([6 x i8]* @p_str9, [2 x i8]* @p_str3, i1* %B, i32 0) nounwind, !dbg !871
  call void (...)* @_ssdm_op_SpecSensitive([6 x i8]* @p_str9, [8 x i8]* @p_str4, i1* %carryIn, i32 0) nounwind, !dbg !872
  call void (...)* @_ssdm_op_SpecSensitive([6 x i8]* @p_str9, [3 x i8]* @p_str6, i2* %op, i32 0) nounwind, !dbg !873
  call void (...)* @_ssdm_op_SpecPort([8 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [2 x i8]* @p_str2, i32 0, i32 0, i1* %A) nounwind, !dbg !874
  call void (...)* @_ssdm_op_SpecPort([8 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [2 x i8]* @p_str3, i32 0, i32 0, i1* %B) nounwind, !dbg !875
  call void (...)* @_ssdm_op_SpecPort([8 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [8 x i8]* @p_str4, i32 0, i32 0, i1* %carryIn) nounwind, !dbg !876
  call void (...)* @_ssdm_op_SpecPort([8 x i8]* @p_str, i32 0, [13 x i8]* @p_str5, [3 x i8]* @p_str6, i32 0, i32 0, i2* %op) nounwind, !dbg !877
  call void (...)* @_ssdm_op_SpecPort([8 x i8]* @p_str, i32 1, [7 x i8]* @p_str1, [2 x i8]* @p_str7, i32 0, i32 0, i1* %C) nounwind, !dbg !878
  call void (...)* @_ssdm_op_SpecPort([8 x i8]* @p_str, i32 1, [7 x i8]* @p_str1, [9 x i8]* @p_str8, i32 0, i32 0, i1* %carryOut) nounwind, !dbg !879
  ret void, !dbg !880
}
...
define void @"ula_new::opUla"(i1* %A, i1* %B, i1* %carryIn, i2* %op, i1* %C, i1* %carryOut) {
  ...
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %C), !map !94
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %carryOut), !map !98
  call void @llvm.dbg.value(metadata !{i1* %A}, i64 0, metadata !881), !dbg !885
  call void @llvm.dbg.value(metadata !{i1* %B}, i64 0, metadata !886), !dbg !885
  call void @llvm.dbg.value(metadata !{i1* %carryIn}, i64 0, metadata !887), !dbg !885
  call void @llvm.dbg.value(metadata !{i2* %op}, i64 0, metadata !888), !dbg !885
  call void @llvm.dbg.value(metadata !{i1* %C}, i64 0, metadata !889), !dbg !885
  call void @llvm.dbg.value(metadata !{i1* %carryOut}, i64 0, metadata !890), !dbg !885
  call void (...)* @_ssdm_op_SpecPort([8 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [2 x i8]* @p_str2, i32 0, i32 0, i1* %A) nounwind, !dbg !891
  call void (...)* @_ssdm_op_SpecPort([8 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [2 x i8]* @p_str3, i32 0, i32 0, i1* %B) nounwind, !dbg !893
  call void (...)* @_ssdm_op_SpecPort([8 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [8 x i8]* @p_str4, i32 0, i32 0, i1* %carryIn) nounwind, !dbg !894
  call void (...)* @_ssdm_op_SpecPort([8 x i8]* @p_str, i32 0, [13 x i8]* @p_str5, [3 x i8]* @p_str6, i32 0, i32 0, i2* %op) nounwind, !dbg !895
  call void (...)* @_ssdm_op_SpecPort([8 x i8]* @p_str, i32 1, [7 x i8]* @p_str1, [2 x i8]* @p_str7, i32 0, i32 0, i1* %C) nounwind, !dbg !896
  call void (...)* @_ssdm_op_SpecPort([8 x i8]* @p_str, i32 1, [7 x i8]* @p_str1, [9 x i8]* @p_str8, i32 0, i32 0, i1* %carryOut) nounwind, !dbg !897
  call void (...)* @_ssdm_op_SpecProcessDef([8 x i8]* @p_str, i32 0, [6 x i8]* @p_str9) nounwind, !dbg !898
  %tmp = call i32 (...)* @_ssdm_op_SpecRegionBegin([10 x i8]* @p_str10), !dbg !899
  call void (...)* @_ssdm_op_SpecProtocol(i32 1) nounwind, !dbg !900
  %val_V = call i2 @_ssdm_op_Read.ap_auto.volatile.i2P(i2* %op), !dbg !901
  call void @llvm.dbg.value(metadata !{i2 %val_V}, i64 0, metadata !920), !dbg !901
...
; <label>:1                                       ; preds = %0
  call void @llvm.dbg.value(metadata !{i1* %A}, i64 0, metadata !922), !dbg !929
  %tmp_1 = call i1 @_ssdm_op_Read.ap_auto.volatile.i1P(i1* %A), !dbg !938
  call void @llvm.dbg.value(metadata !{i1 %tmp_1}, i64 0, metadata !940), !dbg !930
  call void @llvm.dbg.value(metadata !{i1* %B}, i64 0, metadata !922), !dbg !941
  %tmp_2 = call i1 @_ssdm_op_Read.ap_auto.volatile.i1P(i1* %B), !dbg !945
  call void @llvm.dbg.value(metadata !{i1 %tmp_2}, i64 0, metadata !940), !dbg !942
  %aux = xor i1 %tmp_1, %tmp_2, !dbg !944
  call void @llvm.dbg.value(metadata !{i1 %aux}, i64 0, metadata !946), !dbg !944
  %tmp_3 = call i1 @_ssdm_op_Read.ap_auto.volatile.i1P(i1* %A), !dbg !947
  call void @llvm.dbg.value(metadata !{i1 %tmp_3}, i64 0, metadata !940), !dbg !948
  br i1 %tmp_3, label %2, label %._crit_edge, !dbg !950

; <label>:2                                       ; preds = %1
  call void @llvm.dbg.value(metadata !{i1* %B}, i64 0, metadata !922), !dbg !951
  %tmp_6 = call i1 @_ssdm_op_Read.ap_auto.volatile.i1P(i1* %B), !dbg !955
  call void @llvm.dbg.value(metadata !{i1 %tmp_6}, i64 0, metadata !940), !dbg !952
  br label %._crit_edge

; <label>:3                                       ; preds = %0
  call void @llvm.dbg.value(metadata !{i1* %A}, i64 0, metadata !922), !dbg !956
  %tmp_4 = call i1 @_ssdm_op_Read.ap_auto.volatile.i1P(i1* %A), !dbg !960
  call void @llvm.dbg.value(metadata !{i1 %tmp_4}, i64 0, metadata !940), !dbg !957
  br i1 %tmp_4, label %4, label %._crit_edge, !dbg !959

; <label>:4                                       ; preds = %3
  call void @llvm.dbg.value(metadata !{i1* %B}, i64 0, metadata !922), !dbg !961
  %tmp_7 = call i1 @_ssdm_op_Read.ap_auto.volatile.i1P(i1* %B), !dbg !965
  call void @llvm.dbg.value(metadata !{i1 %tmp_7}, i64 0, metadata !940), !dbg !962
  br label %._crit_edge

; <label>:5                                       ; preds = %0
  call void @llvm.dbg.value(metadata !{i1* %A}, i64 0, metadata !922), !dbg !966
  %tmp_5 = call i1 @_ssdm_op_Read.ap_auto.volatile.i1P(i1* %A), !dbg !970
  call void @llvm.dbg.value(metadata !{i1 %tmp_5}, i64 0, metadata !940), !dbg !967
  br i1 %tmp_5, label %._crit_edge, label %6, !dbg !969

; <label>:6                                       ; preds = %5
  call void @llvm.dbg.value(metadata !{i1* %B}, i64 0, metadata !922), !dbg !971
  %tmp_8 = call i1 @_ssdm_op_Read.ap_auto.volatile.i1P(i1* %B), !dbg !975
  call void @llvm.dbg.value(metadata !{i1 %tmp_8}, i64 0, metadata !940), !dbg !972
  br label %._crit_edge, !dbg !974
...
._crit_edge:                                      ; preds = %6, %5, %4, %3, %2, %1, %0
  ...
  call void @llvm.dbg.value(metadata !{i1 %v}, i64 0, metadata !976), !dbg !983
  call void @llvm.dbg.value(metadata !{i1* %C}, i64 0, metadata !988), !dbg !994
  call void @_ssdm_op_Write.ap_auto.volatile.i1P(i1* %C, i1 %v), !dbg !996
  call void @llvm.dbg.value(metadata !{i1 %v_1}, i64 0, metadata !976), !dbg !998
  call void @llvm.dbg.value(metadata !{i1* %carryOut}, i64 0, metadata !988), !dbg !1001
  call void @_ssdm_op_Write.ap_auto.volatile.i1P(i1* %carryOut, i1 %v_1), !dbg !1003
  %empty = call i32 (...)* @_ssdm_op_SpecRegionEnd([10 x i8]* @p_str10, i32 %tmp), !dbg !1004
  ret void, !dbg !1005
}
