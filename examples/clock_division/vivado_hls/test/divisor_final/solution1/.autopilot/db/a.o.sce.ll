...
define weak void @"simple_counter::simple_counter"(i1* %start, i1* %clk, i1* %reset, i10* %final, i1* %count_out, i32* %simple_counter_aux_V, i1* %simple_counter_saida) {
  ...
  call void @llvm.dbg.value(metadata !{i1* %start}, i64 0, metadata !133), !dbg !2289
  call void @llvm.dbg.value(metadata !{i1* %clk}, i64 0, metadata !2290), !dbg !2289
  call void @llvm.dbg.value(metadata !{i1* %reset}, i64 0, metadata !2291), !dbg !2289
  call void @llvm.dbg.value(metadata !{i10* %final}, i64 0, metadata !2292), !dbg !2289
  call void @llvm.dbg.value(metadata !{i1* %count_out}, i64 0, metadata !2308), !dbg !2289
  call void @llvm.dbg.value(metadata !{i32* %simple_counter_aux_V}, i64 0, metadata !2319), !dbg !2289
  call void @llvm.dbg.value(metadata !{i1* %simple_counter_saida}, i64 0, metadata !2329), !dbg !2289
  call void (...)* @_ssdm_op_SpecTopModule([15 x i8]* @p_str, [15 x i8]* @p_str) nounwind, !dbg !2333
  %simple_counter_ss = load i1* @simple_counter_ssdm_thread_M_counting, align 1, !dbg !2335
  br i1 %simple_counter_ss, label %1, label %2, !dbg !2335

; <label>:1                                       ; preds = %0
  call void @"simple_counter::counting"(i1* %start, i1* %clk, i1* %reset, i10* %final, i1* %count_out, i32* %simple_counter_aux_V, i1* %simple_counter_saida), !dbg !2336
  unreachable

; <label>:2                                       ; preds = %0
  call void (...)* @_ssdm_op_SpecProcessDecl([15 x i8]* @p_str, i32 2, [9 x i8]* @p_str8) nounwind, !dbg !2337
  call void (...)* @_ssdm_op_SpecSensitive([9 x i8]* @p_str8, [4 x i8]* @p_str3, i1* %clk, i32 1) nounwind, !dbg !2338
  call void (...)* @_ssdm_op_SpecSensitive([9 x i8]* @p_str8, [6 x i8]* @p_str4, i1* %reset, i32 3) nounwind, !dbg !2339
  call void (...)* @_ssdm_op_SpecPort([15 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [6 x i8]* @p_str2, i32 0, i32 0, i1* %start) nounwind, !dbg !2340
  call void (...)* @_ssdm_op_SpecPort([15 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [4 x i8]* @p_str3, i32 0, i32 0, i1* %clk) nounwind, !dbg !2341
  call void (...)* @_ssdm_op_SpecPort([15 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [6 x i8]* @p_str4, i32 0, i32 0, i1* %reset) nounwind, !dbg !2342
  call void (...)* @_ssdm_op_SpecPort([15 x i8]* @p_str, i32 0, [14 x i8]* @p_str5, [6 x i8]* @p_str6, i32 0, i32 0, i10* %final) nounwind, !dbg !2343
  call void (...)* @_ssdm_op_SpecPort([15 x i8]* @p_str, i32 1, [7 x i8]* @p_str1, [10 x i8]* @p_str7, i32 0, i32 0, i1* %count_out) nounwind, !dbg !2344
  ret void, !dbg !2345
}
...
_ZN7_ap_sc_7sc_core4waitEi.exit2:
  %v_1 = alloca i1
  call void @llvm.dbg.declare(metadata !{i1* %v_1}, metadata !2346)
  ...
  call void (...)* @_ssdm_op_SpecBitsMap(i32* %simple_counter_aux_V), !map !125
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %simple_counter_saida), !map !129
  call void @llvm.dbg.value(metadata !{i1* %start}, i64 0, metadata !2353), !dbg !2357
  call void @llvm.dbg.value(metadata !{i1* %clk}, i64 0, metadata !2358), !dbg !2357
  call void @llvm.dbg.value(metadata !{i1* %reset}, i64 0, metadata !2359), !dbg !2357
  call void @llvm.dbg.value(metadata !{i10* %final}, i64 0, metadata !2360), !dbg !2357
  call void @llvm.dbg.value(metadata !{i1* %count_out}, i64 0, metadata !2361), !dbg !2357
  call void @llvm.dbg.value(metadata !{i32* %simple_counter_aux_V}, i64 0, metadata !2362), !dbg !2357
  call void @llvm.dbg.value(metadata !{i1* %simple_counter_saida}, i64 0, metadata !2363), !dbg !2357
  call void (...)* @_ssdm_op_SpecPort([15 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [6 x i8]* @p_str2, i32 0, i32 0, i1* %start) nounwind, !dbg !2364
  call void (...)* @_ssdm_op_SpecPort([15 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [4 x i8]* @p_str3, i32 0, i32 0, i1* %clk) nounwind, !dbg !2366
  call void (...)* @_ssdm_op_SpecPort([15 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [6 x i8]* @p_str4, i32 0, i32 0, i1* %reset) nounwind, !dbg !2367
  call void (...)* @_ssdm_op_SpecPort([15 x i8]* @p_str, i32 0, [14 x i8]* @p_str5, [6 x i8]* @p_str6, i32 0, i32 0, i10* %final) nounwind, !dbg !2368
  call void (...)* @_ssdm_op_SpecPort([15 x i8]* @p_str, i32 1, [7 x i8]* @p_str1, [10 x i8]* @p_str7, i32 0, i32 0, i1* %count_out) nounwind, !dbg !2369
  call void (...)* @_ssdm_op_SpecProcessDef([15 x i8]* @p_str, i32 2, [9 x i8]* @p_str8) nounwind, !dbg !2370
  %tmp_4 = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @p_str9), !dbg !2371
  call void (...)* @_ssdm_op_SpecProtocol(i32 1, [1 x i8]* @p_str10) nounwind, !dbg !2372
  %p_ssdm_reset_v = call i32 (...)* @_ssdm_op_SpecStateBegin(i32 0, i32 0, i32 1) nounwind, !dbg !2373
  call void @llvm.dbg.value(metadata !{i32 %p_ssdm_reset_v}, i64 0, metadata !2374), !dbg !2373
  call void @_ssdm_op_Write.ap_auto.i32P(i32* %simple_counter_aux_V, i32 0), !dbg !2375
  call void @_ssdm_op_Write.ap_auto.i1P(i1* %simple_counter_saida, i1 false), !dbg !2379
  call void @llvm.dbg.value(metadata !{i1* %count_out}, i64 0, metadata !2380), !dbg !2387
  call void @_ssdm_op_Write.ap_auto.volatile.i1P(i1* %count_out, i1 false), !dbg !2393
  %empty = call i32 (...)* @_ssdm_op_SpecStateEnd(i32 %p_ssdm_reset_v) nounwind, !dbg !2396
  %empty_3 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @p_str9, i32 %tmp_4), !dbg !2397
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !2398
...
; <label>:0                                       ; preds = %_ZN7_ap_sc_7sc_core4waitEi.exit, %_ZN7_ap_sc_7sc_core4waitEi.exit2
  call void @llvm.dbg.value(metadata !{i1* %start}, i64 0, metadata !2406), !dbg !2412
  %tmp = call i1 @_ssdm_op_Read.ap_auto.volatile.i1P(i1* %start), !dbg !2421
  call void @llvm.dbg.value(metadata !{i1 %tmp}, i64 0, metadata !2423), !dbg !2413
  br i1 %tmp, label %1, label %_ZN7_ap_sc_7sc_core4waitEi.exit, !dbg !2419

; <label>:1                                       ; preds = %0
  %simple_counter_aux_V_2 = load i32* %simple_counter_aux_V_1, !dbg !2424
  %tmp_1 = add i32 %simple_counter_aux_V_2, 1, !dbg !2424
  call void @_ssdm_op_Write.ap_auto.i32P(i32* %simple_counter_aux_V, i32 %tmp_1), !dbg !2435
  %val_V = call i10 @_ssdm_op_Read.ap_auto.volatile.i10P(i10* %final), !dbg !2436
  call void @llvm.dbg.value(metadata !{i10 %val_V}, i64 0, metadata !2454), !dbg !2436
  %tmp_2 = zext i10 %val_V to i32, !dbg !2456
  %tmp_3 = icmp eq i32 %tmp_1, %tmp_2, !dbg !2456
  br i1 %tmp_3, label %2, label %_ZN7_ap_sc_7sc_core4waitEi.exit.pre, !dbg !2453

; <label>:2                                       ; preds = %1
  %v_1_load = load i1* %v_1, !dbg !2459
  call void @_ssdm_op_Write.ap_auto.i32P(i32* %simple_counter_aux_V, i32 0), !dbg !2461
  %v = xor i1 %v_1_load, true, !dbg !2459
  call void @_ssdm_op_Write.ap_auto.i1P(i1* %simple_counter_saida, i1 %v), !dbg !2463
  call void @llvm.dbg.value(metadata !{i1* %simple_counter_saida}, i64 0, metadata !2465), !dbg !2466
  call void @llvm.dbg.value(metadata !{i1* %simple_counter_saida}, i64 0, metadata !2468), !dbg !2469
  call void @llvm.dbg.value(metadata !{i1 %v}, i64 0, metadata !2346), !dbg !2471
  call void @llvm.dbg.value(metadata !{i1* %count_out}, i64 0, metadata !2380), !dbg !2472
  call void @_ssdm_op_Write.ap_auto.volatile.i1P(i1* %count_out, i1 %v), !dbg !2474
  store i32 0, i32* %simple_counter_aux_V_1
  store i1 %v, i1* %v_1, !dbg !2471
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit, !dbg !2475
...
_ZN7_ap_sc_7sc_core4waitEi.exit:                  ; preds = %_ZN7_ap_sc_7sc_core4waitEi.exit.pre, %2, %0
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !2476
  br label %0, !dbg !2478
}
