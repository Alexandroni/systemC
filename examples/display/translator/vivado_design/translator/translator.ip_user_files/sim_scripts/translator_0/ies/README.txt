...
#
# Generated by export_simulation on Mon Dec 11 13:15:36 -02 2017
#
################################################################################
...
'-reset_run' switch to the './translator_0.sh' script.

./translator_0.sh -reset_run
...
./translator_0.sh -noclean_files

For more information on the script, please type './translator_0.sh -help'.
