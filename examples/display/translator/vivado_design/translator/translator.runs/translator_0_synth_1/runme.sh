...
HD_PWD='/home/alexandroni/Dropbox/TCC-JOAO-PEDRO/Vivado/final/examples/display/translator/vivado_design/translator/translator.runs/translator_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log translator_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source translator_0.tcl
