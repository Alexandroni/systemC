...
HD_PWD='/home/alexandroni/Dropbox/TCC-JOAO-PEDRO/Vivado/final/examples/display/translator/vivado_design/translator/translator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_translate.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_translate.tcl -notrace
