...
HD_PWD='/home/alexandroni/Dropbox/TCC-JOAO-PEDRO/Vivado/final/examples/display/translator/vivado_design/translator/translator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_translate.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_translate.tcl
