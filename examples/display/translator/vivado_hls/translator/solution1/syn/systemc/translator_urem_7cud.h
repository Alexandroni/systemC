...
#ifndef __translator_urem_7cud__HH__
#define __translator_urem_7cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(translator_urem_7cud) {
    ...
    SC_CTOR(translator_urem_7cud):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
