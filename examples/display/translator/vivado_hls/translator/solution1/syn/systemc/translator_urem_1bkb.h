...
#ifndef __translator_urem_1bkb__HH__
#define __translator_urem_1bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(translator_urem_1bkb) {
    ...
    SC_CTOR(translator_urem_1bkb):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
