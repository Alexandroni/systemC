...
HD_PWD='/home/alexandroni/Dropbox/TCC-JOAO-PEDRO/Vivado/final/examples/display/translator/vivado_hls/translator/solution1/impl/verilog/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log translator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source translator.tcl -notrace
