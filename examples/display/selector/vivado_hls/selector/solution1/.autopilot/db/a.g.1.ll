; ModuleID = '/home/alexandroni/Dropbox/TCC-JOAO-PEDRO/Vivado/final/examples/display/selector/vivado_hls/selector/solution1/.autopilot/db/a.g.1.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.selector.13 = type { %"class._ap_sc_::sc_core::sc_in.4", %"class._ap_sc_::sc_core::sc_in.4", %"class._ap_sc_::sc_core::sc_in.4", %"class._ap_sc_::sc_core::sc_out.12", i32 }
...
@ssdm_ins_selector_0_0 = global %struct.selector.13 zeroinitializer, align 4 ; [#uses=0 type=%struct.selector.13*]
...
; [#uses=0]
define weak void @"selector::selector"(%struct.selector.13* %this, %"class.std::ios_base::Init.0"*) unnamed_addr nounwind uwtable align 2 {
  call void @llvm.dbg.value(metadata !{%struct.selector.13* %this}, i64 0, metadata !3623), !dbg !3625 ; [debug line = 11:3] [debug variable = this]
  call void (...)* @_ssdm_op_SpecTopModule(i8* getelementptr inbounds ([9 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !3626 ; [debug line = 13:5]
  call void (...)* @_ssdm_InlineSelf(i32 2) nounwind, !dbg !3628 ; [debug line = 13:73]
  %"selector::__ssdm_thread_M_select.load" = load i1* @"selector::__ssdm_thread_M_select", align 1, !dbg !3629 ; [#uses=1 type=i1] [debug line = 14:5]
  br i1 %"selector::__ssdm_thread_M_select.load", label %2, label %3, !dbg !3629 ; [debug line = 14:5]

; <label>:2                                       ; preds = %1
  call void @"selector::select"(%struct.selector.13* %this), !dbg !3630 ; [debug line = 14:33]
  unreachable

; <label>:3                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecProcessDecl(i8* getelementptr inbounds ([9 x i8]* @.str, i64 0, i64 0), i32 2, i8* getelementptr inbounds ([7 x i8]* @.str7, i64 0, i64 0)) nounwind, !dbg !3631 ; [debug line = 14:43]
  %this.addr = getelementptr inbounds %struct.selector.13* %this, i64 0, i32 0, !dbg !3632 ; [#uses=3 type=%"class._ap_sc_::sc_core::sc_in.4"*] [debug line = 15:5]
  call void (...)* @_ssdm_op_SpecSensitive(i8* getelementptr inbounds ([7 x i8]* @.str7, i64 0, i64 0), i8* getelementptr inbounds ([4 x i8]* @.str2, i64 0, i64 0), %"class._ap_sc_::sc_core::sc_in.4"* %this.addr, i32 1) nounwind, !dbg !3632 ; [debug line = 15:5]
  %this.addr.1 = getelementptr inbounds %struct.selector.13* %this, i64 0, i32 1, !dbg !3633 ; [#uses=3 type=%"class._ap_sc_::sc_core::sc_in.4"*] [debug line = 16:5]
  call void (...)* @_ssdm_op_SpecSensitive(i8* getelementptr inbounds ([7 x i8]* @.str7, i64 0, i64 0), i8* getelementptr inbounds ([6 x i8]* @.str3, i64 0, i64 0), %"class._ap_sc_::sc_core::sc_in.4"* %this.addr.1, i32 3) nounwind, !dbg !3633 ; [debug line = 16:5]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([9 x i8]* @.str, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([7 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([4 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, %"class._ap_sc_::sc_core::sc_in.4"* %this.addr) nounwind, !dbg !3634 ; [debug line = 17:5]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([9 x i8]* @.str, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([7 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([6 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, %"class._ap_sc_::sc_core::sc_in.4"* %this.addr.1) nounwind, !dbg !3635 ; [debug line = 18:5]
  %this.addr.2 = getelementptr inbounds %struct.selector.13* %this, i64 0, i32 2, !dbg !3636 ; [#uses=2 type=%"class._ap_sc_::sc_core::sc_in.4"*] [debug line = 19:5]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([9 x i8]* @.str, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([7 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([6 x i8]* @.str4, i64 0, i64 0), i32 0, i32 0, %"class._ap_sc_::sc_core::sc_in.4"* %this.addr.2) nounwind, !dbg !3636 ; [debug line = 19:5]
  %this.addr.3 = getelementptr inbounds %struct.selector.13* %this, i64 0, i32 3, !dbg !3637 ; [#uses=2 type=%"class._ap_sc_::sc_core::sc_out.12"*] [debug line = 20:5]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([9 x i8]* @.str, i64 0, i64 0), i32 1, i8* getelementptr inbounds ([13 x i8]* @.str5, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8]* @.str6, i64 0, i64 0), i32 0, i32 0, %"class._ap_sc_::sc_core::sc_out.12"* %this.addr.3) nounwind, !dbg !3637 ; [debug line = 20:5]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str10, i64 0, i64 0), i8* getelementptr inbounds ([4 x i8]* @.str2, i64 0, i64 0), %"class._ap_sc_::sc_core::sc_in.4"* %this.addr) nounwind, !dbg !3638 ; [debug line = 21:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str10, i64 0, i64 0), i8* getelementptr inbounds ([6 x i8]* @.str3, i64 0, i64 0), %"class._ap_sc_::sc_core::sc_in.4"* %this.addr.1) nounwind, !dbg !3639 ; [debug line = 22:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str10, i64 0, i64 0), i8* getelementptr inbounds ([6 x i8]* @.str4, i64 0, i64 0), %"class._ap_sc_::sc_core::sc_in.4"* %this.addr.2) nounwind, !dbg !3640 ; [debug line = 23:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str10, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8]* @.str6, i64 0, i64 0), %"class._ap_sc_::sc_core::sc_out.12"* %this.addr.3) nounwind, !dbg !3641 ; [debug line = 24:1]
  %this.addr.4 = getelementptr inbounds %struct.selector.13* %this, i64 0, i32 4, !dbg !3642 ; [#uses=1 type=i32*] [debug line = 25:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str10, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str11, i64 0, i64 0), i32* %this.addr.4) nounwind, !dbg !3642 ; [debug line = 25:1]
  ret void, !dbg !3643                            ; [debug line = 20:1]
}

; [#uses=1]
define void @"selector::select"(%struct.selector.13* %this) noreturn nounwind uwtable noinline align 2 {
  call void @llvm.dbg.value(metadata !{%struct.selector.13* %this}, i64 0, metadata !3644), !dbg !3645 ; [debug line = 3:16] [debug variable = this]
  %this.addr = getelementptr inbounds %struct.selector.13* %this, i64 0, i32 0, !dbg !3646 ; [#uses=2 type=%"class._ap_sc_::sc_core::sc_in.4"*] [debug line = 4:4]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([9 x i8]* @.str, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([7 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([4 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, %"class._ap_sc_::sc_core::sc_in.4"* %this.addr) nounwind, !dbg !3646 ; [debug line = 4:4]
  %this.addr.5 = getelementptr inbounds %struct.selector.13* %this, i64 0, i32 1, !dbg !3648 ; [#uses=2 type=%"class._ap_sc_::sc_core::sc_in.4"*] [debug line = 5:3]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([9 x i8]* @.str, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([7 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([6 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, %"class._ap_sc_::sc_core::sc_in.4"* %this.addr.5) nounwind, !dbg !3648 ; [debug line = 5:3]
  %this.addr.6 = getelementptr inbounds %struct.selector.13* %this, i64 0, i32 2, !dbg !3649 ; [#uses=2 type=%"class._ap_sc_::sc_core::sc_in.4"*] [debug line = 6:3]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([9 x i8]* @.str, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([7 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([6 x i8]* @.str4, i64 0, i64 0), i32 0, i32 0, %"class._ap_sc_::sc_core::sc_in.4"* %this.addr.6) nounwind, !dbg !3649 ; [debug line = 6:3]
  %this.addr.7 = getelementptr inbounds %struct.selector.13* %this, i64 0, i32 3, !dbg !3650 ; [#uses=2 type=%"class._ap_sc_::sc_core::sc_out.12"*] [debug line = 7:3]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([9 x i8]* @.str, i64 0, i64 0), i32 1, i8* getelementptr inbounds ([13 x i8]* @.str5, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8]* @.str6, i64 0, i64 0), i32 0, i32 0, %"class._ap_sc_::sc_core::sc_out.12"* %this.addr.7) nounwind, !dbg !3650 ; [debug line = 7:3]
  call void (...)* @_ssdm_op_SpecProcessDef(i8* getelementptr inbounds ([9 x i8]* @.str, i64 0, i64 0), i32 2, i8* getelementptr inbounds ([7 x i8]* @.str7, i64 0, i64 0)) nounwind, !dbg !3651 ; [debug line = 8:3]
  call void (...)* @_ssdm_InlineSelf(i32 2) nounwind, !dbg !3652 ; [debug line = 8:85]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([15 x i8]* @.str8, i64 0, i64 0)) nounwind, !dbg !3653 ; [#uses=1 type=i32] [debug line = 8:106]
  call void (...)* @_ssdm_UnrollRegion(i32 0, i32 0, i32 0, i8* getelementptr inbounds ([15 x i8]* @.str8, i64 0, i64 0)) nounwind, !dbg !3654 ; [debug line = 8:143]
  call void (...)* @_ssdm_op_SpecProtocol(i32 1, i8* getelementptr inbounds ([1 x i8]* @.str9, i64 0, i64 0)) nounwind, !dbg !3655 ; [debug line = 8:190]
  %_ssdm_reset_v = call i32 (...)* @_ssdm_op_SpecStateBegin(i32 0, i32 0, i32 1) nounwind, !dbg !3656 ; [#uses=1 type=i32] [debug line = 8:240]
  call void @llvm.dbg.value(metadata !{i32 %_ssdm_reset_v}, i64 0, metadata !3657), !dbg !3656 ; [debug line = 8:240] [debug variable = _ssdm_reset_v]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str10, i64 0, i64 0), i8* getelementptr inbounds ([4 x i8]* @.str2, i64 0, i64 0), %"class._ap_sc_::sc_core::sc_in.4"* %this.addr) nounwind, !dbg !3658 ; [debug line = 9:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str10, i64 0, i64 0), i8* getelementptr inbounds ([6 x i8]* @.str3, i64 0, i64 0), %"class._ap_sc_::sc_core::sc_in.4"* %this.addr.5) nounwind, !dbg !3659 ; [debug line = 10:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str10, i64 0, i64 0), i8* getelementptr inbounds ([6 x i8]* @.str4, i64 0, i64 0), %"class._ap_sc_::sc_core::sc_in.4"* %this.addr.6) nounwind, !dbg !3660 ; [debug line = 11:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str10, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8]* @.str6, i64 0, i64 0), %"class._ap_sc_::sc_core::sc_out.12"* %this.addr.7) nounwind, !dbg !3661 ; [debug line = 12:1]
  %this.addr.8 = getelementptr inbounds %struct.selector.13* %this, i64 0, i32 4, !dbg !3662 ; [#uses=5 type=i32*] [debug line = 13:1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str10, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str11, i64 0, i64 0), i32* %this.addr.8) nounwind, !dbg !3662 ; [debug line = 13:1]
  store i32 0, i32* %this.addr.8, align 4, !dbg !3663 ; [debug line = 6:1]
  %this.addr.9 = getelementptr inbounds %struct.selector.13* %this, i64 0, i32 3, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, !dbg !3664 ; [#uses=6 type=i4*] [debug line = 365:13@108:100@207:13@414:73@7:1]
  store volatile i4 -1, i4* %this.addr.9, align 1, !dbg !3664 ; [debug line = 365:13@108:100@207:13@414:73@7:1]
  %1 = call i32 (...)* @_ssdm_op_SpecStateEnd(i32 %_ssdm_reset_v) nounwind, !dbg !3673 ; [#uses=0 type=i32] [debug line = 7:21]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([15 x i8]* @.str8, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !3674 ; [#uses=0 type=i32] [debug line = 7:59]
  %P.assign = getelementptr inbounds %struct.selector.13* %this, i64 0, i32 2, i32 0, i32 0, i32 0, !dbg !3675 ; [#uses=1 type=i1*] [debug line = 180:66@369:68@10:6]
  br label %2, !dbg !3681                         ; [debug line = 7:94]

; <label>:2                                       ; preds = %_ZN7_ap_sc_7sc_core4waitEi.exit, %0
  call void @llvm.dbg.value(metadata !{i1* %P.assign}, i64 0, metadata !3682), !dbg !3683 ; [debug line = 166:90@180:66@369:68@10:6] [debug variable = P]
  %tmp = load volatile i1* %P.assign, align 1, !dbg !3684 ; [#uses=1 type=i1] [debug line = 166:95@180:66@369:68@10:6]
  call void @llvm.dbg.value(metadata !{i1 %tmp}, i64 0, metadata !3686), !dbg !3675 ; [debug line = 180:66@369:68@10:6] [debug variable = tmp]
  br i1 %tmp, label %3, label %_ZN7_ap_sc_7sc_core4waitEi.exit, !dbg !3679 ; [debug line = 10:6]

; <label>:3                                       ; preds = %2
  %this.load = load i32* %this.addr.8, align 4, !dbg !3687 ; [#uses=3 type=i32] [debug line = 11:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %this.load) nounwind
  %tmp.1 = add nsw i32 %this.load, 1, !dbg !3687  ; [#uses=4 type=i32] [debug line = 11:4]
  store i32 %tmp.1, i32* %this.addr.8, align 4, !dbg !3687 ; [debug line = 11:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %tmp.1) nounwind
  switch i32 %this.load, label %8 [
    i32 0, label %4
    i32 1, label %5
    i32 2, label %6
    i32 3, label %7
  ], !dbg !3689                                   ; [debug line = 13:13]

; <label>:4                                       ; preds = %3
  store volatile i4 7, i4* %this.addr.9, align 1, !dbg !3690 ; [debug line = 365:13@108:100@207:13@414:73@15:21]
  br label %9, !dbg !3696                         ; [debug line = 16:21]

; <label>:5                                       ; preds = %3
  store volatile i4 -5, i4* %this.addr.9, align 1, !dbg !3697 ; [debug line = 365:13@108:100@207:13@414:73@18:21]
  br label %9, !dbg !3702                         ; [debug line = 19:21]

; <label>:6                                       ; preds = %3
  store volatile i4 -3, i4* %this.addr.9, align 1, !dbg !3703 ; [debug line = 365:13@108:100@207:13@414:73@21:21]
  br label %9, !dbg !3708                         ; [debug line = 22:21]

; <label>:7                                       ; preds = %3
  store volatile i4 -2, i4* %this.addr.9, align 1, !dbg !3709 ; [debug line = 365:13@108:100@207:13@414:73@24:21]
  br label %9, !dbg !3714                         ; [debug line = 25:21]

; <label>:8                                       ; preds = %3
  store volatile i4 -1, i4* %this.addr.9, align 1, !dbg !3715 ; [debug line = 365:13@108:100@207:13@414:73@27:21]
  br label %9, !dbg !3720                         ; [debug line = 28:21]

; <label>:9                                       ; preds = %8, %7, %6, %5, %4
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %tmp.1) nounwind
  %tmp.2 = icmp sgt i32 %tmp.1, 3, !dbg !3721     ; [#uses=1 type=i1] [debug line = 32:13]
  br i1 %tmp.2, label %10, label %._crit_edge, !dbg !3721 ; [debug line = 32:13]

; <label>:10                                      ; preds = %9
  store i32 0, i32* %this.addr.8, align 4, !dbg !3722 ; [debug line = 33:17]
  br label %._crit_edge, !dbg !3724               ; [debug line = 34:13]

._crit_edge:                                      ; preds = %10, %9
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit, !dbg !3725 ; [debug line = 36:3]

_ZN7_ap_sc_7sc_core4waitEi.exit:                  ; preds = %._crit_edge, %2
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !3726 ; [debug line = 803:19@37:3]
  br label %2, !dbg !3730                         ; [debug line = 38:2]
}
...
!llvm.dbg.cu = !{!0}
!opencl.kernels = !{!3582, !3589, !3589, !3595, !3597, !3598, !3600, !3602, !3608, !3610, !3610, !3615, !3617, !3597, !3597, !3597, !3597, !3597, !3597, !3597, !3597, !3597, !3597, !3597, !3597, !3597, !3597, !3597, !3597, !3597, !3618, !3597, !3597, !3620}
!hls.encrypted.func = !{}
...
!944 = metadata !{i32 786478, i32 0, null, metadata !"select", metadata !"select", metadata !"_ZN8selector6selectEv", metadata !945, i32 3, metadata !946, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (%struct.selector.13*)* @"selector::select", null, metadata !1782, metadata !89, i32 4} ; [ DW_TAG_subprogram ]
...
!1797 = metadata !{i32 786478, i32 0, metadata !1083, metadata !"sc_uint", metadata !"sc_uint", metadata !"_ZN7_ap_sc_5sc_dt7sc_uintILi4EEC1Ei", metadata !1085, i32 343, metadata !1650, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1649, metadata !89, i32 343} ; [ DW_TAG_subprogram ]
!1798 = metadata !{i32 786478, i32 0, metadata !1083, metadata !"sc_uint", metadata !"sc_uint", metadata !"_ZN7_ap_sc_5sc_dt7sc_uintILi4EEC2Ei", metadata !1085, i32 343, metadata !1650, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1649, metadata !89, i32 343} ; [ DW_TAG_subprogram ]
!1799 = metadata !{i32 786478, i32 0, null, metadata !"ap_int_base", metadata !"ap_int_base", metadata !"_ZN11ap_int_baseILi4ELb0ELb1EEC2Ei", metadata !891, i32 1521, metadata !1140, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1139, metadata !89, i32 1521} ; [ DW_TAG_subprogram ]
!1800 = metadata !{i32 786478, i32 0, null, metadata !"ssdm_int", metadata !"ssdm_int", metadata !"_ZN8ssdm_intILi4ELb0EEC2Ev", metadata !1092, i32 10, metadata !1097, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1096, metadata !89, i32 10} ; [ DW_TAG_subprogram ]
!1801 = metadata !{i32 786478, i32 0, metadata !954, metadata !"write", metadata !"write", metadata !"_ZN7_ap_sc_7sc_core8sc_inoutINS_5sc_dt7sc_uintILi4EEEE5writeERKS4_", metadata !956, i32 414, metadata !1756, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1755, metadata !89, i32 414} ; [ DW_TAG_subprogram ]
!1802 = metadata !{i32 786478, i32 0, metadata !954, metadata !"write<_ap_sc_::sc_dt::sc_uint<4> >", metadata !"write<_ap_sc_::sc_dt::sc_uint<4> >", metadata !"_ZN7_ap_sc_7sc_core18sc_signal_inout_ifINS_5sc_dt7sc_uintILi4EEEE5writeIS4_EEvRKT_", metadata !956, i32 205, metadata !1803, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, metadata !1805, null, metadata !89, i32 205} ; [ DW_TAG_subprogram ]
...
!1814 = metadata !{i32 786478, i32 0, metadata !1083, metadata !"operator=", metadata !"operator=", metadata !"_ZNV7_ap_sc_5sc_dt7sc_uintILi4EEaSERKS2_", metadata !1085, i32 364, metadata !1674, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1673, metadata !89, i32 364} ; [ DW_TAG_subprogram ]
!1815 = metadata !{i32 786478, i32 0, metadata !954, metadata !"sc_module_name", metadata !"sc_module_name", metadata !"_ZN7_ap_sc_7sc_core14sc_module_nameC1EPKc", metadata !956, i32 581, metadata !1789, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1788, metadata !89, i32 581} ; [ DW_TAG_subprogram ]
!1816 = metadata !{i32 786478, i32 0, metadata !954, metadata !"sc_module_name", metadata !"sc_module_name", metadata !"_ZN7_ap_sc_7sc_core14sc_module_nameC2EPKc", metadata !956, i32 581, metadata !1789, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1788, metadata !89, i32 581} ; [ DW_TAG_subprogram ]
!1817 = metadata !{i32 786478, i32 0, null, metadata !"selector", metadata !"selector", metadata !"_ZN8selectorC1EN7_ap_sc_7sc_core14sc_module_nameE", metadata !950, i32 11, metadata !1784, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1783, metadata !89, i32 12} ; [ DW_TAG_subprogram ]
!1818 = metadata !{i32 786478, i32 0, null, metadata !"selector", metadata !"selector", metadata !"_ZN8selectorC2EN7_ap_sc_7sc_core14sc_module_nameE", metadata !950, i32 11, metadata !1784, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (%struct.selector.13*, %"class.std::ios_base::Init.0"*)* @"selector::selector", null, metadata !1783, metadata !89, i32 12} ; [ DW_TAG_subprogram ]
!1819 = metadata !{i32 786478, i32 0, metadata !954, metadata !"sc_out", metadata !"sc_out", metadata !"_ZN7_ap_sc_7sc_core6sc_outINS_5sc_dt7sc_uintILi4EEEEC1Ev", metadata !956, i32 430, metadata !1775, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1774, metadata !89, i32 430} ; [ DW_TAG_subprogram ]
!1820 = metadata !{i32 786478, i32 0, metadata !954, metadata !"sc_out", metadata !"sc_out", metadata !"_ZN7_ap_sc_7sc_core6sc_outINS_5sc_dt7sc_uintILi4EEEEC2Ev", metadata !956, i32 430, metadata !1775, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1774, metadata !89, i32 430} ; [ DW_TAG_subprogram ]
!1821 = metadata !{i32 786478, i32 0, metadata !954, metadata !"sc_inout", metadata !"sc_inout", metadata !"_ZN7_ap_sc_7sc_core8sc_inoutINS_5sc_dt7sc_uintILi4EEEEC2Ev", metadata !956, i32 410, metadata !1749, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1748, metadata !89, i32 410} ; [ DW_TAG_subprogram ]
!1822 = metadata !{i32 786478, i32 0, metadata !954, metadata !"sc_port_b", metadata !"sc_port_b", metadata !"_ZN7_ap_sc_7sc_core9sc_port_bINS0_18sc_signal_inout_ifINS_5sc_dt7sc_uintILi4EEEEEEC2Ev", metadata !956, i32 272, metadata !1723, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1722, metadata !89, i32 272} ; [ DW_TAG_subprogram ]
!1823 = metadata !{i32 786478, i32 0, metadata !954, metadata !"sc_signal_inout_if", metadata !"sc_signal_inout_if", metadata !"_ZN7_ap_sc_7sc_core18sc_signal_inout_ifINS_5sc_dt7sc_uintILi4EEEEC1Ev", metadata !956, i32 197, metadata !1713, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1712, metadata !89, i32 197} ; [ DW_TAG_subprogram ]
...
!1825 = metadata !{i32 786478, i32 0, metadata !954, metadata !"sc_signal_in_if", metadata !"sc_signal_in_if", metadata !"_ZN7_ap_sc_7sc_core15sc_signal_in_ifINS_5sc_dt7sc_uintILi4EEEEC2Ev", metadata !956, i32 176, metadata !1693, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1692, metadata !89, i32 176} ; [ DW_TAG_subprogram ]
!1826 = metadata !{i32 786478, i32 0, metadata !1083, metadata !"sc_uint", metadata !"sc_uint", metadata !"_ZN7_ap_sc_5sc_dt7sc_uintILi4EEC1Ev", metadata !1085, i32 272, metadata !1604, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1603, metadata !89, i32 272} ; [ DW_TAG_subprogram ]
!1827 = metadata !{i32 786478, i32 0, metadata !1083, metadata !"sc_uint", metadata !"sc_uint", metadata !"_ZN7_ap_sc_5sc_dt7sc_uintILi4EEC2Ev", metadata !1085, i32 272, metadata !1604, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1603, metadata !89, i32 272} ; [ DW_TAG_subprogram ]
!1828 = metadata !{i32 786478, i32 0, null, metadata !"ap_int_base", metadata !"ap_int_base", metadata !"_ZN11ap_int_baseILi4ELb0ELb1EEC2Ev", metadata !891, i32 1494, metadata !1104, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1103, metadata !89, i32 1494} ; [ DW_TAG_subprogram ]
!1829 = metadata !{i32 786478, i32 0, metadata !954, metadata !"sc_interface", metadata !"sc_interface", metadata !"_ZN7_ap_sc_7sc_core12sc_interfaceC2Ev", metadata !956, i32 165, metadata !975, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !974, metadata !89, i32 165} ; [ DW_TAG_subprogram ]
!1830 = metadata !{i32 786478, i32 0, metadata !954, metadata !"sc_port_base", metadata !"sc_port_base", metadata !"_ZN7_ap_sc_7sc_core12sc_port_baseC2Ev", metadata !956, i32 265, metadata !965, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !964, metadata !89, i32 265} ; [ DW_TAG_subprogram ]
!1831 = metadata !{i32 786478, i32 0, metadata !954, metadata !"sc_in", metadata !"sc_in", metadata !"_ZN7_ap_sc_7sc_core5sc_inIbEC1Ev", metadata !956, i32 365, metadata !1037, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1036, metadata !89, i32 365} ; [ DW_TAG_subprogram ]
!1832 = metadata !{i32 786478, i32 0, metadata !954, metadata !"sc_in", metadata !"sc_in", metadata !"_ZN7_ap_sc_7sc_core5sc_inIbEC2Ev", metadata !956, i32 365, metadata !1037, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1036, metadata !89, i32 365} ; [ DW_TAG_subprogram ]
!1833 = metadata !{i32 786478, i32 0, metadata !954, metadata !"sc_port_b", metadata !"sc_port_b", metadata !"_ZN7_ap_sc_7sc_core9sc_port_bINS0_15sc_signal_in_ifIbEEEC2Ev", metadata !956, i32 272, metadata !1002, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1001, metadata !89, i32 272} ; [ DW_TAG_subprogram ]
!1834 = metadata !{i32 786478, i32 0, metadata !954, metadata !"sc_signal_in_if", metadata !"sc_signal_in_if", metadata !"_ZN7_ap_sc_7sc_core15sc_signal_in_ifIbEC1Ev", metadata !956, i32 176, metadata !981, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !980, metadata !89, i32 176} ; [ DW_TAG_subprogram ]
!1835 = metadata !{i32 786478, i32 0, metadata !954, metadata !"sc_signal_in_if", metadata !"sc_signal_in_if", metadata !"_ZN7_ap_sc_7sc_core15sc_signal_in_ifIbEC2Ev", metadata !956, i32 176, metadata !981, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !980, metadata !89, i32 176} ; [ DW_TAG_subprogram ]
!1836 = metadata !{i32 786478, i32 0, metadata !954, metadata !"wait", metadata !"wait", metadata !"_ZN7_ap_sc_7sc_core4waitEi", metadata !956, i32 802, metadata !1837, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !89, i32 802} ; [ DW_TAG_subprogram ]
!1837 = metadata !{i32 786453, i32 0, metadata !"", i32 0, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !1838, i32 0, i32 0} ; [ DW_TAG_subroutine_type ]
!1838 = metadata !{null, metadata !56}
!1839 = metadata !{i32 786478, i32 0, metadata !954, metadata !"read", metadata !"read", metadata !"_ZN7_ap_sc_7sc_core5sc_inIbE4readEv", metadata !956, i32 369, metadata !1044, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1043, metadata !89, i32 369} ; [ DW_TAG_subprogram ]
!1840 = metadata !{i32 786478, i32 0, metadata !954, metadata !"read", metadata !"read", metadata !"_ZN7_ap_sc_7sc_core15sc_signal_in_ifIbE4readEv", metadata !956, i32 180, metadata !985, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !984, metadata !89, i32 180} ; [ DW_TAG_subprogram ]
!1841 = metadata !{i32 786478, i32 0, metadata !1842, metadata !"_ssdm_op_READ<bool>", metadata !"_ssdm_op_READ<bool>", metadata !"_Z13_ssdm_op_READIbET_RVS0_", metadata !1842, i32 166, metadata !1843, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, metadata !1846, null, metadata !89, i32 166} ; [ DW_TAG_subprogram ]
...
!1898 = metadata !{i32 786484, i32 0, metadata !1899, metadata !"__ioinit", metadata !"__ioinit", metadata !"_ZStL8__ioinit", metadata !1900, i32 74, metadata !1901, i32 1, i32 1, null} ; [ DW_TAG_variable ]
...
!1911 = metadata !{i32 786484, i32 0, null, metadata !"ssdm_ins_selector_0_0", metadata !"ssdm_ins_selector_0_0", metadata !"", metadata !945, i32 42, metadata !949, i32 0, i32 1, %struct.selector.13* @ssdm_ins_selector_0_0} ; [ DW_TAG_variable ]
!1912 = metadata !{i32 786484, i32 0, null, metadata !"__is_signed", metadata !"__is_signed", metadata !"_ZN9__gnu_cxx24__numeric_traits_integer11__is_signedE", metadata !1913, i32 73, metadata !995, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1914 = metadata !{i32 786484, i32 0, null, metadata !"__digits", metadata !"__digits", metadata !"_ZN9__gnu_cxx24__numeric_traits_integer8__digitsE", metadata !1913, i32 76, metadata !168, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1915 = metadata !{i32 786484, i32 0, null, metadata !"__max_digits10", metadata !"__max_digits10", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating14__max_digits10E", metadata !1913, i32 111, metadata !168, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1916 = metadata !{i32 786484, i32 0, null, metadata !"__is_signed", metadata !"__is_signed", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating11__is_signedE", metadata !1913, i32 114, metadata !995, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1917 = metadata !{i32 786484, i32 0, null, metadata !"__digits10", metadata !"__digits10", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating10__digits10E", metadata !1913, i32 117, metadata !168, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1918 = metadata !{i32 786484, i32 0, null, metadata !"__max_exponent10", metadata !"__max_exponent10", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating16__max_exponent10E", metadata !1913, i32 120, metadata !168, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1919 = metadata !{i32 786484, i32 0, null, metadata !"__daylight", metadata !"__daylight", metadata !"", metadata !1920, i32 283, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1921 = metadata !{i32 786484, i32 0, null, metadata !"daylight", metadata !"daylight", metadata !"", metadata !1920, i32 297, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1922 = metadata !{i32 786484, i32 0, null, metadata !"getdate_err", metadata !"getdate_err", metadata !"", metadata !1920, i32 403, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1923 = metadata !{i32 786484, i32 0, null, metadata !"optind", metadata !"optind", metadata !"", metadata !1924, i32 72, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1925 = metadata !{i32 786484, i32 0, null, metadata !"opterr", metadata !"opterr", metadata !"", metadata !1924, i32 77, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1926 = metadata !{i32 786484, i32 0, null, metadata !"optopt", metadata !"optopt", metadata !"", metadata !1924, i32 81, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1927 = metadata !{i32 786484, i32 0, metadata !1928, metadata !"nothrow", metadata !"nothrow", metadata !"_ZSt7nothrow", metadata !1929, i32 70, metadata !1930, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1932 = metadata !{i32 786484, i32 0, metadata !115, metadata !"_S_once", metadata !"_S_once", metadata !"_ZNSt6locale7_S_onceE", metadata !117, i32 307, metadata !1933, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1935 = metadata !{i32 786484, i32 0, metadata !128, metadata !"_S_once", metadata !"_S_once", metadata !"_ZNSt6locale5facet7_S_onceE", metadata !117, i32 353, metadata !1933, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1936 = metadata !{i32 786484, i32 0, metadata !251, metadata !"_S_refcount", metadata !"_S_refcount", metadata !"_ZNSt6locale2id11_S_refcountE", metadata !117, i32 456, metadata !84, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1937 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt7collate2idE", metadata !117, i32 634, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1938 = metadata !{i32 786484, i32 0, metadata !1901, metadata !"_S_refcount", metadata !"_S_refcount", metadata !"_ZNSt8ios_base4Init11_S_refcountE", metadata !5, i32 542, metadata !84, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1939 = metadata !{i32 786484, i32 0, metadata !1901, metadata !"_S_synced_with_stdio", metadata !"_S_synced_with_stdio", metadata !"_ZNSt8ios_base4Init20_S_synced_with_stdioE", metadata !5, i32 543, metadata !238, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1940 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt5ctype2idE", metadata !1941, i32 613, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2044 = metadata !{i32 786484, i32 0, metadata !1959, metadata !"id", metadata !"id", metadata !"_ZNSt5ctypeIcE2idE", metadata !1941, i32 696, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2045 = metadata !{i32 786484, i32 0, metadata !2046, metadata !"id", metadata !"id", metadata !"_ZNSt5ctypeIwE2idE", metadata !1941, i32 1198, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2178 = metadata !{i32 786484, i32 0, metadata !2179, metadata !"_S_atoms_out", metadata !"_S_atoms_out", metadata !"_ZNSt10__num_base12_S_atoms_outE", metadata !1941, i32 1543, metadata !172, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2185 = metadata !{i32 786484, i32 0, metadata !2179, metadata !"_S_atoms_in", metadata !"_S_atoms_in", metadata !"_ZNSt10__num_base11_S_atoms_inE", metadata !1941, i32 1547, metadata !172, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2186 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt8numpunct2idE", metadata !1941, i32 1657, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2187 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt7num_get2idE", metadata !1941, i32 1926, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2188 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt7num_put2idE", metadata !1941, i32 2264, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2189 = metadata !{i32 786484, i32 0, metadata !1899, metadata !"cin", metadata !"cin", metadata !"_ZSt3cin", metadata !1900, i32 60, metadata !2190, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2870 = metadata !{i32 786484, i32 0, metadata !1899, metadata !"cout", metadata !"cout", metadata !"_ZSt4cout", metadata !1900, i32 61, metadata !2871, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2872 = metadata !{i32 786484, i32 0, metadata !1899, metadata !"cerr", metadata !"cerr", metadata !"_ZSt4cerr", metadata !1900, i32 62, metadata !2871, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2873 = metadata !{i32 786484, i32 0, metadata !1899, metadata !"clog", metadata !"clog", metadata !"_ZSt4clog", metadata !1900, i32 63, metadata !2871, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2874 = metadata !{i32 786484, i32 0, metadata !1899, metadata !"wcin", metadata !"wcin", metadata !"_ZSt4wcin", metadata !1900, i32 66, metadata !2875, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!3547 = metadata !{i32 786484, i32 0, metadata !1899, metadata !"wcout", metadata !"wcout", metadata !"_ZSt5wcout", metadata !1900, i32 67, metadata !3548, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!3549 = metadata !{i32 786484, i32 0, metadata !1899, metadata !"wcerr", metadata !"wcerr", metadata !"_ZSt5wcerr", metadata !1900, i32 68, metadata !3548, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!3550 = metadata !{i32 786484, i32 0, metadata !1899, metadata !"wclog", metadata !"wclog", metadata !"_ZSt5wclog", metadata !1900, i32 69, metadata !3548, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!3551 = metadata !{i32 786484, i32 0, null, metadata !"_IO_2_1_stdin_", metadata !"_IO_2_1_stdin_", metadata !"", metadata !3552, i32 321, metadata !3553, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!3554 = metadata !{i32 786484, i32 0, null, metadata !"_IO_2_1_stdout_", metadata !"_IO_2_1_stdout_", metadata !"", metadata !3552, i32 322, metadata !3553, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!3555 = metadata !{i32 786484, i32 0, null, metadata !"_IO_2_1_stderr_", metadata !"_IO_2_1_stderr_", metadata !"", metadata !3552, i32 323, metadata !3553, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!3556 = metadata !{i32 786484, i32 0, null, metadata !"sys_nerr", metadata !"sys_nerr", metadata !"", metadata !3557, i32 26, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!3558 = metadata !{i32 786484, i32 0, null, metadata !"_sys_nerr", metadata !"_sys_nerr", metadata !"", metadata !3557, i32 30, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!3559 = metadata !{i32 786484, i32 0, null, metadata !"signgam", metadata !"signgam", metadata !"", metadata !3560, i32 149, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!3561 = metadata !{i32 786484, i32 0, metadata !954, metadata !"SC_BIND_PROXY_NIL", metadata !"SC_BIND_PROXY_NIL", metadata !"_ZN7_ap_sc_7sc_core17SC_BIND_PROXY_NILE", metadata !956, i32 505, metadata !3562, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!3581 = metadata !{i32 786484, i32 0, metadata !949, metadata !"__ssdm_thread_M_select", metadata !"__ssdm_thread_M_select", metadata !"_ZN8selector22__ssdm_thread_M_selectE", metadata !950, i32 4, metadata !238, i32 0, i32 1, i1* @"selector::__ssdm_thread_M_select"} ; [ DW_TAG_variable ]
!3582 = metadata !{void (%struct.selector.13*)* @"selector::select", metadata !3583, metadata !3584, metadata !3585, metadata !3586, metadata !3587, metadata !3588}
...
!3589 = metadata !{null, metadata !3590, metadata !3591, metadata !3592, metadata !3593, metadata !3594, metadata !3588}
...
!3595 = metadata !{null, metadata !3590, metadata !3591, metadata !3592, metadata !3593, metadata !3596, metadata !3588}
!3596 = metadata !{metadata !"kernel_arg_name", metadata !"op"}
!3597 = metadata !{null, metadata !3583, metadata !3584, metadata !3585, metadata !3586, metadata !3587, metadata !3588}
!3598 = metadata !{null, metadata !3590, metadata !3591, metadata !3599, metadata !3593, metadata !3594, metadata !3588}
!3599 = metadata !{metadata !"kernel_arg_type", metadata !"const struct _ap_sc_::sc_dt::sc_uint<4> &"}
!3600 = metadata !{null, metadata !3590, metadata !3591, metadata !3599, metadata !3593, metadata !3601, metadata !3588}
!3601 = metadata !{metadata !"kernel_arg_name", metadata !"v2"}
!3602 = metadata !{null, metadata !3603, metadata !3604, metadata !3605, metadata !3606, metadata !3607, metadata !3588}
!3603 = metadata !{metadata !"kernel_arg_addr_space", i32 0, i32 0}
!3604 = metadata !{metadata !"kernel_arg_access_qual", metadata !"none", metadata !"none"}
!3605 = metadata !{metadata !"kernel_arg_type", metadata !"volatile sc_uint<4> &", metadata !"const struct _ap_sc_::sc_dt::sc_uint<4> &"}
!3606 = metadata !{metadata !"kernel_arg_type_qual", metadata !"", metadata !""}
!3607 = metadata !{metadata !"kernel_arg_name", metadata !"P", metadata !"val"}
!3608 = metadata !{null, metadata !3590, metadata !3591, metadata !3599, metadata !3593, metadata !3609, metadata !3588}
!3609 = metadata !{metadata !"kernel_arg_name", metadata !"op2"}
!3610 = metadata !{null, metadata !3611, metadata !3591, metadata !3612, metadata !3613, metadata !3614, metadata !3588}
!3611 = metadata !{metadata !"kernel_arg_addr_space", i32 1}
!3612 = metadata !{metadata !"kernel_arg_type", metadata !"char*"}
!3613 = metadata !{metadata !"kernel_arg_type_qual", metadata !"const"}
!3614 = metadata !{metadata !"kernel_arg_name", metadata !""}
!3615 = metadata !{null, metadata !3590, metadata !3591, metadata !3616, metadata !3593, metadata !3614, metadata !3588}
!3616 = metadata !{metadata !"kernel_arg_type", metadata !"::sc_core::sc_module_name"}
!3617 = metadata !{void (%struct.selector.13*, %"class.std::ios_base::Init.0"*)* @"selector::selector", metadata !3590, metadata !3591, metadata !3616, metadata !3593, metadata !3614, metadata !3588}
!3618 = metadata !{null, metadata !3590, metadata !3591, metadata !3592, metadata !3593, metadata !3619, metadata !3588}
!3619 = metadata !{metadata !"kernel_arg_name", metadata !"n"}
!3620 = metadata !{null, metadata !3590, metadata !3591, metadata !3621, metadata !3593, metadata !3622, metadata !3588}
!3621 = metadata !{metadata !"kernel_arg_type", metadata !"volatile _Bool &"}
!3622 = metadata !{metadata !"kernel_arg_name", metadata !"P"}
!3623 = metadata !{i32 786689, metadata !1818, metadata !"this", metadata !950, i32 16777227, metadata !3624, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!3624 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !949} ; [ DW_TAG_pointer_type ]
!3625 = metadata !{i32 11, i32 3, metadata !1818, null}
!3626 = metadata !{i32 13, i32 5, metadata !3627, null}
!3627 = metadata !{i32 786443, metadata !1818, i32 12, i32 2, metadata !950, i32 13} ; [ DW_TAG_lexical_block ]
!3628 = metadata !{i32 13, i32 73, metadata !3627, null}
!3629 = metadata !{i32 14, i32 5, metadata !3627, null}
!3630 = metadata !{i32 14, i32 33, metadata !3627, null}
!3631 = metadata !{i32 14, i32 43, metadata !3627, null}
!3632 = metadata !{i32 15, i32 5, metadata !3627, null}
!3633 = metadata !{i32 16, i32 5, metadata !3627, null}
!3634 = metadata !{i32 17, i32 5, metadata !3627, null}
!3635 = metadata !{i32 18, i32 5, metadata !3627, null}
!3636 = metadata !{i32 19, i32 5, metadata !3627, null}
!3637 = metadata !{i32 20, i32 5, metadata !3627, null}
!3638 = metadata !{i32 21, i32 1, metadata !3627, null}
!3639 = metadata !{i32 22, i32 1, metadata !3627, null}
!3640 = metadata !{i32 23, i32 1, metadata !3627, null}
!3641 = metadata !{i32 24, i32 1, metadata !3627, null}
!3642 = metadata !{i32 25, i32 1, metadata !3627, null}
!3643 = metadata !{i32 20, i32 1, metadata !3627, null}
!3644 = metadata !{i32 786689, metadata !944, metadata !"this", metadata !945, i32 16777219, metadata !3624, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!3645 = metadata !{i32 3, i32 16, metadata !944, null}
!3646 = metadata !{i32 4, i32 4, metadata !3647, null}
!3647 = metadata !{i32 786443, metadata !944, i32 4, i32 1, metadata !945, i32 0} ; [ DW_TAG_lexical_block ]
!3648 = metadata !{i32 5, i32 3, metadata !3647, null}
!3649 = metadata !{i32 6, i32 3, metadata !3647, null}
!3650 = metadata !{i32 7, i32 3, metadata !3647, null}
!3651 = metadata !{i32 8, i32 3, metadata !3647, null}
!3652 = metadata !{i32 8, i32 85, metadata !3647, null}
!3653 = metadata !{i32 8, i32 106, metadata !3647, null}
!3654 = metadata !{i32 8, i32 143, metadata !3647, null}
!3655 = metadata !{i32 8, i32 190, metadata !3647, null}
!3656 = metadata !{i32 8, i32 240, metadata !3647, null}
!3657 = metadata !{i32 786688, metadata !3647, metadata !"_ssdm_reset_v", metadata !945, i32 8, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3658 = metadata !{i32 9, i32 1, metadata !3647, null}
!3659 = metadata !{i32 10, i32 1, metadata !3647, null}
!3660 = metadata !{i32 11, i32 1, metadata !3647, null}
!3661 = metadata !{i32 12, i32 1, metadata !3647, null}
!3662 = metadata !{i32 13, i32 1, metadata !3647, null}
!3663 = metadata !{i32 6, i32 1, metadata !3647, null}
!3664 = metadata !{i32 365, i32 13, metadata !3665, metadata !3666}
!3665 = metadata !{i32 786443, metadata !1814, i32 364, i32 86, metadata !1085, i32 11} ; [ DW_TAG_lexical_block ]
!3666 = metadata !{i32 108, i32 100, metadata !3667, metadata !3668}
!3667 = metadata !{i32 786443, metadata !1807, i32 108, i32 98, metadata !1842, i32 10} ; [ DW_TAG_lexical_block ]
!3668 = metadata !{i32 207, i32 13, metadata !3669, metadata !3670}
!3669 = metadata !{i32 786443, metadata !1802, i32 205, i32 73, metadata !956, i32 9} ; [ DW_TAG_lexical_block ]
!3670 = metadata !{i32 414, i32 73, metadata !3671, metadata !3672}
!3671 = metadata !{i32 786443, metadata !1801, i32 414, i32 71, metadata !956, i32 8} ; [ DW_TAG_lexical_block ]
!3672 = metadata !{i32 7, i32 1, metadata !3647, null}
!3673 = metadata !{i32 7, i32 21, metadata !3647, null}
!3674 = metadata !{i32 7, i32 59, metadata !3647, null}
!3675 = metadata !{i32 180, i32 66, metadata !3676, metadata !3677}
!3676 = metadata !{i32 786443, metadata !1840, i32 180, i32 56, metadata !956, i32 31} ; [ DW_TAG_lexical_block ]
!3677 = metadata !{i32 369, i32 68, metadata !3678, metadata !3679}
!3678 = metadata !{i32 786443, metadata !1839, i32 369, i32 59, metadata !956, i32 30} ; [ DW_TAG_lexical_block ]
!3679 = metadata !{i32 10, i32 6, metadata !3680, null}
!3680 = metadata !{i32 786443, metadata !3647, i32 9, i32 1, metadata !945, i32 1} ; [ DW_TAG_lexical_block ]
!3681 = metadata !{i32 7, i32 94, metadata !3647, null}
!3682 = metadata !{i32 786689, metadata !1841, metadata !"P", metadata !1842, i32 16777382, metadata !1845, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3683 = metadata !{i32 166, i32 90, metadata !1841, metadata !3675}
!3684 = metadata !{i32 166, i32 95, metadata !3685, metadata !3675}
!3685 = metadata !{i32 786443, metadata !1841, i32 166, i32 93, metadata !1842, i32 32} ; [ DW_TAG_lexical_block ]
!3686 = metadata !{i32 786688, metadata !3676, metadata !"tmp", metadata !956, i32 180, metadata !238, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3687 = metadata !{i32 11, i32 4, metadata !3688, null}
!3688 = metadata !{i32 786443, metadata !3680, i32 10, i32 19, metadata !945, i32 2} ; [ DW_TAG_lexical_block ]
!3689 = metadata !{i32 13, i32 13, metadata !3688, null}
!3690 = metadata !{i32 365, i32 13, metadata !3665, metadata !3691}
!3691 = metadata !{i32 108, i32 100, metadata !3667, metadata !3692}
!3692 = metadata !{i32 207, i32 13, metadata !3669, metadata !3693}
!3693 = metadata !{i32 414, i32 73, metadata !3671, metadata !3694}
!3694 = metadata !{i32 15, i32 21, metadata !3695, null}
!3695 = metadata !{i32 786443, metadata !3688, i32 13, i32 29, metadata !945, i32 3} ; [ DW_TAG_lexical_block ]
!3696 = metadata !{i32 16, i32 21, metadata !3695, null}
!3697 = metadata !{i32 365, i32 13, metadata !3665, metadata !3698}
!3698 = metadata !{i32 108, i32 100, metadata !3667, metadata !3699}
!3699 = metadata !{i32 207, i32 13, metadata !3669, metadata !3700}
!3700 = metadata !{i32 414, i32 73, metadata !3671, metadata !3701}
!3701 = metadata !{i32 18, i32 21, metadata !3695, null}
!3702 = metadata !{i32 19, i32 21, metadata !3695, null}
!3703 = metadata !{i32 365, i32 13, metadata !3665, metadata !3704}
!3704 = metadata !{i32 108, i32 100, metadata !3667, metadata !3705}
!3705 = metadata !{i32 207, i32 13, metadata !3669, metadata !3706}
!3706 = metadata !{i32 414, i32 73, metadata !3671, metadata !3707}
!3707 = metadata !{i32 21, i32 21, metadata !3695, null}
!3708 = metadata !{i32 22, i32 21, metadata !3695, null}
!3709 = metadata !{i32 365, i32 13, metadata !3665, metadata !3710}
!3710 = metadata !{i32 108, i32 100, metadata !3667, metadata !3711}
!3711 = metadata !{i32 207, i32 13, metadata !3669, metadata !3712}
!3712 = metadata !{i32 414, i32 73, metadata !3671, metadata !3713}
!3713 = metadata !{i32 24, i32 21, metadata !3695, null}
!3714 = metadata !{i32 25, i32 21, metadata !3695, null}
!3715 = metadata !{i32 365, i32 13, metadata !3665, metadata !3716}
!3716 = metadata !{i32 108, i32 100, metadata !3667, metadata !3717}
!3717 = metadata !{i32 207, i32 13, metadata !3669, metadata !3718}
!3718 = metadata !{i32 414, i32 73, metadata !3671, metadata !3719}
!3719 = metadata !{i32 27, i32 21, metadata !3695, null}
!3720 = metadata !{i32 28, i32 21, metadata !3695, null}
!3721 = metadata !{i32 32, i32 13, metadata !3688, null}
!3722 = metadata !{i32 33, i32 17, metadata !3723, null}
!3723 = metadata !{i32 786443, metadata !3688, i32 32, i32 30, metadata !945, i32 4} ; [ DW_TAG_lexical_block ]
!3724 = metadata !{i32 34, i32 13, metadata !3723, null}
!3725 = metadata !{i32 36, i32 3, metadata !3688, null}
!3726 = metadata !{i32 803, i32 19, metadata !3727, metadata !3729}
!3727 = metadata !{i32 786443, metadata !3728, i32 803, i32 17, metadata !956, i32 27} ; [ DW_TAG_lexical_block ]
!3728 = metadata !{i32 786443, metadata !1836, i32 802, i32 58, metadata !956, i32 26} ; [ DW_TAG_lexical_block ]
!3729 = metadata !{i32 37, i32 3, metadata !3680, null}
!3730 = metadata !{i32 38, i32 2, metadata !3680, null}
