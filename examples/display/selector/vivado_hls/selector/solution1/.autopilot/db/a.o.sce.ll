...
define weak void @"selector::selector"(i1* %clk, i1* %reset, i1* %start, i4* %selected, i32* %selector_counter) {
  ...
  call void @llvm.dbg.value(metadata !{i1* %clk}, i64 0, metadata !96), !dbg !979
  call void @llvm.dbg.value(metadata !{i1* %reset}, i64 0, metadata !980), !dbg !979
  call void @llvm.dbg.value(metadata !{i1* %start}, i64 0, metadata !981), !dbg !979
  call void @llvm.dbg.value(metadata !{i4* %selected}, i64 0, metadata !982), !dbg !979
  call void @llvm.dbg.value(metadata !{i32* %selector_counter}, i64 0, metadata !1002), !dbg !979
  call void (...)* @_ssdm_op_SpecTopModule([9 x i8]* @p_str, [9 x i8]* @p_str) nounwind, !dbg !1006
  %selector_ssdm_thr = load i1* @selector_ssdm_thread_M_select, align 1, !dbg !1008
  br i1 %selector_ssdm_thr, label %1, label %2, !dbg !1008

; <label>:1                                       ; preds = %0
  call void @"selector::select"(i1* %clk, i1* %reset, i1* %start, i4* %selected, i32* %selector_counter), !dbg !1009
  unreachable

; <label>:2                                       ; preds = %0
  call void (...)* @_ssdm_op_SpecProcessDecl([9 x i8]* @p_str, i32 2, [7 x i8]* @p_str7) nounwind, !dbg !1010
  call void (...)* @_ssdm_op_SpecSensitive([7 x i8]* @p_str7, [4 x i8]* @p_str2, i1* %clk, i32 1) nounwind, !dbg !1011
  call void (...)* @_ssdm_op_SpecSensitive([7 x i8]* @p_str7, [6 x i8]* @p_str3, i1* %reset, i32 3) nounwind, !dbg !1012
  call void (...)* @_ssdm_op_SpecPort([9 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [4 x i8]* @p_str2, i32 0, i32 0, i1* %clk) nounwind, !dbg !1013
  call void (...)* @_ssdm_op_SpecPort([9 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [6 x i8]* @p_str3, i32 0, i32 0, i1* %reset) nounwind, !dbg !1014
  call void (...)* @_ssdm_op_SpecPort([9 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [6 x i8]* @p_str4, i32 0, i32 0, i1* %start) nounwind, !dbg !1015
  call void (...)* @_ssdm_op_SpecPort([9 x i8]* @p_str, i32 1, [13 x i8]* @p_str5, [9 x i8]* @p_str6, i32 0, i32 0, i4* %selected) nounwind, !dbg !1016
  ret void, !dbg !1017
}
...
define void @"selector::select"(i1* %clk, i1* %reset, i1* %start, i4* %selected, i32* %selector_counter) {
  ...
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %selected), !map !88
  call void (...)* @_ssdm_op_SpecBitsMap(i32* %selector_counter), !map !92
  call void @llvm.dbg.value(metadata !{i1* %clk}, i64 0, metadata !1018), !dbg !1022
  call void @llvm.dbg.value(metadata !{i1* %reset}, i64 0, metadata !1023), !dbg !1022
  call void @llvm.dbg.value(metadata !{i1* %start}, i64 0, metadata !1024), !dbg !1022
  call void @llvm.dbg.value(metadata !{i4* %selected}, i64 0, metadata !1025), !dbg !1022
  call void @llvm.dbg.value(metadata !{i32* %selector_counter}, i64 0, metadata !1026), !dbg !1022
  call void (...)* @_ssdm_op_SpecPort([9 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [4 x i8]* @p_str2, i32 0, i32 0, i1* %clk) nounwind, !dbg !1027
  call void (...)* @_ssdm_op_SpecPort([9 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [6 x i8]* @p_str3, i32 0, i32 0, i1* %reset) nounwind, !dbg !1029
  call void (...)* @_ssdm_op_SpecPort([9 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [6 x i8]* @p_str4, i32 0, i32 0, i1* %start) nounwind, !dbg !1030
  call void (...)* @_ssdm_op_SpecPort([9 x i8]* @p_str, i32 1, [13 x i8]* @p_str5, [9 x i8]* @p_str6, i32 0, i32 0, i4* %selected) nounwind, !dbg !1031
  call void (...)* @_ssdm_op_SpecProcessDef([9 x i8]* @p_str, i32 2, [7 x i8]* @p_str7) nounwind, !dbg !1032
  %tmp_3 = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @p_str8), !dbg !1033
  call void (...)* @_ssdm_op_SpecProtocol(i32 1, [1 x i8]* @p_str9) nounwind, !dbg !1034
  %p_ssdm_reset_v = call i32 (...)* @_ssdm_op_SpecStateBegin(i32 0, i32 0, i32 1) nounwind, !dbg !1035
  call void @llvm.dbg.value(metadata !{i32 %p_ssdm_reset_v}, i64 0, metadata !1036), !dbg !1035
  call void @_ssdm_op_Write.ap_auto.i32P(i32* %selector_counter, i32 0), !dbg !1037
  call void @_ssdm_op_Write.ap_auto.volatile.i4P(i4* %selected, i4 -1), !dbg !1038
  %empty = call i32 (...)* @_ssdm_op_SpecStateEnd(i32 %p_ssdm_reset_v) nounwind, !dbg !1062
  %empty_4 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @p_str8, i32 %tmp_3), !dbg !1063
  store i32 0, i32* %selector_counter_loa
  br label %1, !dbg !1064

; <label>:1                                       ; preds = %_ZN7_ap_sc_7sc_core4waitEi.exit, %0
  call void @llvm.dbg.value(metadata !{i1* %start}, i64 0, metadata !1065), !dbg !1072
  %tmp = call i1 @_ssdm_op_Read.ap_auto.volatile.i1P(i1* %start), !dbg !1081
  call void @llvm.dbg.value(metadata !{i1 %tmp}, i64 0, metadata !1083), !dbg !1073
  br i1 %tmp, label %2, label %_ZN7_ap_sc_7sc_core4waitEi.exit, !dbg !1079

; <label>:2                                       ; preds = %1
  %selector_counter_loa_1 = load i32* %selector_counter_loa, !dbg !1084
  %tmp_1 = add nsw i32 %selector_counter_loa_1, 1, !dbg !1084
  call void @_ssdm_op_Write.ap_auto.i32P(i32* %selector_counter, i32 %tmp_1), !dbg !1084
...
; <label>:3                                       ; preds = %2
  call void @_ssdm_op_Write.ap_auto.volatile.i4P(i4* %selected, i4 7), !dbg !1087
  br label %8, !dbg !1093

; <label>:4                                       ; preds = %2
  call void @_ssdm_op_Write.ap_auto.volatile.i4P(i4* %selected, i4 -5), !dbg !1094
  br label %8, !dbg !1099

; <label>:5                                       ; preds = %2
  call void @_ssdm_op_Write.ap_auto.volatile.i4P(i4* %selected, i4 -3), !dbg !1100
  br label %8, !dbg !1105

; <label>:6                                       ; preds = %2
  call void @_ssdm_op_Write.ap_auto.volatile.i4P(i4* %selected, i4 -2), !dbg !1106
  br label %8, !dbg !1111

; <label>:7                                       ; preds = %2
  call void @_ssdm_op_Write.ap_auto.volatile.i4P(i4* %selected, i4 -1), !dbg !1112
  br label %8, !dbg !1117

; <label>:8                                       ; preds = %7, %6, %5, %4, %3
  %tmp_2 = call i30 @_ssdm_op_PartSelect.i30.i32.i32.i32(i32 %tmp_1, i32 2, i32 31), !dbg !1118
  %icmp = icmp sgt i30 %tmp_2, 0, !dbg !1118
  br i1 %icmp, label %9, label %_ZN7_ap_sc_7sc_core4waitEi.exit.pre, !dbg !1118

; <label>:9                                       ; preds = %8
  call void @_ssdm_op_Write.ap_auto.i32P(i32* %selector_counter, i32 0), !dbg !1119
  store i32 0, i32* %selector_counter_loa
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit, !dbg !1121
...
_ZN7_ap_sc_7sc_core4waitEi.exit:                  ; preds = %_ZN7_ap_sc_7sc_core4waitEi.exit.pre, %9, %1
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !1122
  br label %1, !dbg !1129
}
