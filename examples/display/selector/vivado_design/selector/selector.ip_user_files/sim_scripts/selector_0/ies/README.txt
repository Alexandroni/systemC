...
#
# Generated by export_simulation on Sun Dec 10 20:11:06 -02 2017
#
################################################################################
...
'-reset_run' switch to the './selector_0.sh' script.

./selector_0.sh -reset_run
...
./selector_0.sh -noclean_files

For more information on the script, please type './selector_0.sh -help'.
