...
HD_PWD='/home/alexandroni/Dropbox/TCC-JOAO-PEDRO/Vivado/final/examples/display/selector/vivado_design/selector/selector.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_selector.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_selector.tcl
