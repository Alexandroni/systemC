...
HD_PWD='/home/alexandroni/Dropbox/TCC-JOAO-PEDRO/Vivado/final/examples/display/selector/vivado_design/selector/selector.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_selector.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_selector.tcl -notrace
