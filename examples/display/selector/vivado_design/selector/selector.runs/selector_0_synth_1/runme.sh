...
HD_PWD='/home/alexandroni/Dropbox/TCC-JOAO-PEDRO/Vivado/final/examples/display/selector/vivado_design/selector/selector.runs/selector_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log selector_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source selector_0.tcl
